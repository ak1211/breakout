    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind12(liftEffect12(getCanvasElementById(canvasId)))(function(maybeCanvas) {
          ...
          ;
          throw new Error("Failed pattern match at Breakout (line 82, column 5 - line 88, column 18): " + [maybeCanvas.constructor.name]);
        });
      }
      ;
      if (v instanceof Tick) {
        return bind12(get2)(maybe(mempty2)(function(state3) {
          return discard3(liftEffect12(draw(state3.canvas)(state3.dataset)))(function() {
            return put2(new Just(function() {
              ...
              ;
              $52.dataset = nextDataset(state3.dataset);
              return $52;
            }()));
          });
        }));
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 79, column 16 - line 93, column 69): " + [v.constructor.name]);
    };
  };
