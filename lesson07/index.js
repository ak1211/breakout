...
(function($PS) {
  ...
  var render = function (state) {
      ...
      })(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showNumber))(Data_Show.showBoolean))(Data_Show.showNumber))(Data_Show.showBoolean))(Data_Show.showNumber))(Data_Show.showNumber))(Data_Map_Internal.showMap(showBricksIndex)(showBrick))))(state.dataset)) ]);
  };
  var brickWidth = 75;
  var brickRowCount = 3;
  var brickPadding = 10;
  ...
  var nextDataset = function (dataset) {
      return function (c) {
              ...
              return function (bricks) {
                  ...
                  var collisioned = function (v) {
                      return function (v1) {
                          ...
                          throw new Error("Failed pattern match at Breakout (line 394, column 35 - line 399, column 29): " + [ v1.status.constructor.name ]);
                      };
                  };
          ...
          var v = (function () {
              if (collisionedBrick instanceof Data_Maybe.Nothing) {
                  return {
                      nextBricks: dataset.bricks,
                      collisioned: false
                  };
              };
              if (collisionedBrick instanceof Data_Maybe.Just) {
                  return {
                      nextBricks: Data_Map_Internal.insert(ordBricksIndex)(collisionedBrick.value0.value0)(collisionedBrick.value0.value1)(dataset.bricks),
                      collisioned: true
                  };
              };
              throw new Error("Failed pattern match at Breakout (line 337, column 60 - line 345, column 10): " + [ collisionedBrick.constructor.name ]);
          })();
          var v1 = (function () {
              var touchTheFloor = dataset.y + dataset.dy > c.height - ballRadius;
              var touchThePaddle = touchTheFloor && Data_Ord.between(Data_Ord.ordNumber)(dataset.paddleX)(dataset.paddleX + paddleWidth)(dataset.x + dataset.dx);
              ...
              throw new Error("Failed pattern match at Breakout (line 355, column 9 - line 361, column 59): " + [ true ]);
          })();
          return {
              nextDataset: {
                  ...
                  dx: (function () {
                      var $62 = Data_Ord.between(Data_Ord.ordNumber)(ballRadius)(c.width - ballRadius)(dataset.x + dataset.dx);
                      if ($62) {
                          return dataset.dx;
                      };
                      return -dataset.dx;
                  ...
                  dy: v1.nextDy,
                  paddleX: Data_Ord.clamp(Data_Ord.ordNumber)(0.0)(c.width - paddleWidth)(newPaddleX),
      ...
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                      return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                          var $119 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create);
                          return function ($120) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                          return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                              var $121 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create);
                              return function ($122) {
                                  return $121(Web_UIEvent_KeyboardEvent.fromEvent($122));
                              };
                          })());
                      }))(function () {
          ...
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  if ($84.a instanceof Data_Maybe.Just && $84.b instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(draw($84.a.value0)(v1.dataset)))(function (ret) {
                          if (ret.gameover) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.alert("GAME OVER"))(Web_HTML.window)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Location.reload)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.location)(Web_HTML.window))))(function () {
                                      return Halogen_Query_HalogenM.unsubscribe($84.b.value0);
                                  });
                              });
                          };
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $96.dataset = (function () {
                              var $93 = {};
                              for (var $94 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $94)) {
                                      $93[$94] = st["dataset"][$94];
                                  };
                              };
                              $93.rightPressed = true;
                              return $93;
                          })();
                          return $96;
                      });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Left" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowLeft") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $102.dataset = (function () {
                              var $99 = {};
                              for (var $100 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $100)) {
                                      $99[$100] = st["dataset"][$100];
                                  };
                              };
                              $99.leftPressed = true;
                              return $99;
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $109.dataset = (function () {
                              var $106 = {};
                              for (var $107 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $107)) {
                                      $106[$107] = st["dataset"][$107];
                                  };
                              };
                              $106.rightPressed = false;
                              return $106;
                          })();
                          return $109;
                      });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Left" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowLeft") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $115.dataset = (function () {
                              var $112 = {};
                              for (var $113 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $113)) {
                                      $112[$113] = st["dataset"][$113];
                                  };
                              };
                              $112.leftPressed = false;
                              return $112;
                          })();
                          return $115;
                      });
