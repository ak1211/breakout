(() => {
  ...
  })(showRecordFieldsCons2)(showBoolean))(showNumber))(showBoolean))(showNumber))(showNumber))(/* @__PURE__ */ showMap(showBricksIndex)(showBrick))));
  var eqBrickStatus = {
    eq: function(x) {
      return function(y) {
  ...
  var eq12 = /* @__PURE__ */ eq(eqBrickStatus);
  ...
  var ballRadius = 10;
  var nextDataset = function(dataset) {
    return function(c) {
      var collisionDetection = function(ball) {
        return function(bricks) {
          var inactivate = function(v2) {
          ...
          var collisioned = function(v2) {
            return function(v12) {
              if (v12.status instanceof InActive) {
                return false;
              }
              ;
              if (v12.status instanceof Active) {
                if (between2(v12.x)(v12.x + toNumber(brickWidth))(ball.x) && between2(v12.y)(v12.y + toNumber(brickHeight))(ball.y)) {
                  return true;
                }
                ;
                if (otherwise) {
              ...
              ;
              throw new Error("Failed pattern match at Breakout (line 395, column 35 - line 400, column 29): " + [v12.status.constructor.name]);
            };
          };
          return head(map14(inactivate)(toUnfoldableUnordered2(filterWithKey2(collisioned)(bricks))));
        };
      };
      var newPaddleX = function() {
        var $188 = {
          left: dataset.leftPressed,
          right: dataset.rightPressed
        };
        if (!$188.left && $188.right) {
          return dataset.paddleX + 7;
        }
        ;
        if ($188.left && !$188.right) {
          return dataset.paddleX - 7;
        ...
        ;
        return dataset.paddleX;
      }();
      var collisionedBrick = collisionDetection({
        x: dataset.x,
        y: dataset.y
      })(dataset.bricks);
      var v = function() {
        if (collisionedBrick instanceof Nothing) {
          return {
        ...
        ;
        if (collisionedBrick instanceof Just) {
          return {
            nextBricks: insert4(collisionedBrick.value0.value0)(collisionedBrick.value0.value1)(dataset.bricks),
            collisioned: true
          };
        }
        ;
        throw new Error("Failed pattern match at Breakout (line 338, column 60 - line 346, column 10): " + [collisionedBrick.constructor.name]);
      }();
      var v1 = function() {
        var touchTheFloor = dataset.y + dataset.dy > c.height - ballRadius;
        var touchThePaddle = touchTheFloor && between2(dataset.paddleX)(dataset.paddleX + paddleWidth)(dataset.x + dataset.dx);
        var touchTheCeiling = dataset.y + dataset.dy < ballRadius;
        if (touchTheCeiling) {
          return {
            nextDy: -dataset.dy,
            gameover: false
        ...
        ;
        throw new Error("Failed pattern match at Breakout (line 356, column 9 - line 362, column 59): " + [true]);
      }();
      return {
        nextDataset: {
          ...
          dx: function() {
            var $200 = between2(ballRadius)(c.width - ballRadius)(dataset.x + dataset.dx);
            if ($200) {
              return dataset.dx;
            }
            ;
          ...
          dy: v1.nextDy,
          paddleX: clamp3(0)(c.width - paddleWidth)(newPaddleX),
          leftPressed: dataset.leftPressed,
          rightPressed: dataset.rightPressed,
          bricks: v.nextBricks
        },
        gameover: v1.gameover
      };
    };
  };
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function __do2() {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 218, column 11 - line 235, column 16): " + [v.constructor.name]);
    };
    return function(v) {
        ...
        return bind22(liftEffect22(bindFlipped4(document2)(windowImpl)))(function(document3) {
          return discard5(subscribe$prime(function(v1) {
            return eventListener2(keydown)(toEventTarget(document3))(function() {
              var $257 = map15(HandleKeyDown.create);
              return function($258) {
                return $257(fromEvent($258));
              };
            }());
          }))(function() {
            return discard5(subscribe$prime(function(v1) {
              return eventListener2(keyup)(toEventTarget(document3))(function() {
                var $259 = map15(HandleKeyUp.create);
                return function($260) {
                  return $259(fromEvent($260));
                };
              }());
            }))(function() {
      ...
      if (v instanceof Tick) {
        return bind22(get2)(function(v1) {
          ...
          if ($222.a instanceof Just && $222.b instanceof Just) {
            return bind22(liftEffect22(draw($222.a.value0)(v1.dataset)))(function(ret) {
              if (ret.gameover) {
                return discard5(liftEffect22(bindFlipped4(alert("GAME OVER"))(windowImpl)))(function() {
                  return discard5(liftEffect22(bindFlipped4(reload)(bindFlipped4(location)(windowImpl))))(function() {
                    return unsubscribe2($222.b.value0);
                  });
                });
              }
              ;
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $234.dataset = function() {
                var $231 = {};
                for (var $232 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $232)) {
                    $231[$232] = st["dataset"][$232];
                  }
                  ;
                }
                ;
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $240.dataset = function() {
                var $237 = {};
                for (var $238 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $238)) {
                    $237[$238] = st["dataset"][$238];
                  }
                  ;
                }
                ;
                $237.leftPressed = true;
                return $237;
              }();
              return $240;
            });
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $247.dataset = function() {
                var $244 = {};
                for (var $245 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $245)) {
                    $244[$245] = st["dataset"][$245];
                  }
                  ;
                }
                ;
                $244.rightPressed = false;
                return $244;
              }();
              return $247;
            });
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $253.dataset = function() {
                var $250 = {};
                for (var $251 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $251)) {
                    $250[$251] = st["dataset"][$251];
                  }
                  ;
                }
                ;
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 167, column 16 - line 213, column 29): " + [v.constructor.name]);
    };
  };
