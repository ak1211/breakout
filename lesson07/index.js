      ...
      return function (c) {
          var collisionDetection = function (ball) {
              return function (bricks) {
                  var collisioned = function (v) {
                      if (v.value1.status instanceof InActive) {
                          return Data_Maybe.Nothing.value;
                      };
                      if (v.value1.status instanceof Active) {
                          if (Data_Ord.between(Data_Ord.ordNumber)(v.value1.x)(v.value1.x + Data_Int.toNumber(brickWidth))(ball.x) && Data_Ord.between(Data_Ord.ordNumber)(v.value1.y)(v.value1.y + Data_Int.toNumber(brickHeight))(ball.y)) {
                              return Data_Maybe.Just.create(new Data_Tuple.Tuple(v.value0, {
                                  x: v.value1.x,
                                  y: v.value1.y,
                      ...
                      throw new Error("Failed pattern match at Breakout (line 381, column 47 - line 388, column 31): " + [ v.value1.status.constructor.name ]);
                  };
                  var v = Data_Map_Internal.toUnfoldableUnordered(Data_Unfoldable.unfoldableArray)(bricks);
                  return Data_Foldable.findMap(Data_Foldable.foldableArray)(collisioned)(v);
              };
          };
          ...
          var v = (function () {
              if (collisionedBrick instanceof Data_Maybe.Nothing) {
                  return new Data_Tuple.Tuple(dataset.bricks, false);
              };
              if (collisionedBrick instanceof Data_Maybe.Just) {
                  return new Data_Tuple.Tuple(Data_Map_Internal.insert(ordBricksIndex)(collisionedBrick.value0.value0)(collisionedBrick.value0.value1)(dataset.bricks), true);
              };
              throw new Error("Failed pattern match at Breakout (line 337, column 36 - line 339, column 81): " + [ collisionedBrick.constructor.name ]);
          })();
          var v1 = (function () {
              ...
              throw new Error("Failed pattern match at Breakout (line 349, column 9 - line 355, column 59): " + [ true ]);
          })();
          return {
              nextDataset: {
                  ...
                  dx: (function () {
                      var $60 = Data_Ord.between(Data_Ord.ordNumber)(ballRadius)(c.width - ballRadius)(dataset.x + dataset.dx);
                      if ($60) {
                          return dataset.dx;
                      };
                      return -dataset.dx;
      ...
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                      return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                          var $117 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create);
                          return function ($118) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                          return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                              var $119 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create);
                              return function ($120) {
          ...
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  if ($82.a instanceof Data_Maybe.Just && $82.b instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(draw($82.a.value0)(v1.dataset)))(function (ret) {
                          if (ret.gameover) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.alert("GAME OVER"))(Web_HTML.window)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Location.reload)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.location)(Web_HTML.window))))(function () {
                                      return Halogen_Query_HalogenM.unsubscribe($82.b.value0);
                                  });
                              });
                          };
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $94.dataset = (function () {
                              var $91 = {};
                              for (var $92 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $92)) {
                                      $91[$92] = st["dataset"][$92];
                                  };
                              };
                              $91.rightPressed = true;
                              return $91;
                          })();
                          return $94;
                      });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $107.dataset = (function () {
                              var $104 = {};
                              for (var $105 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $105)) {
                                      $104[$105] = st["dataset"][$105];
                                  };
                              };
