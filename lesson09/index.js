(() => {
          ...
          return {
            compareRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  var key5 = reflectSymbol2($$Proxy.value);
                  var left = compare3(unsafeGet(key5)(ra))(unsafeGet(key5)(rb));
        ...
        return {
          showRecordFields: function(v) {
            return function(record) {
              ...
              var key5 = reflectSymbol2($$Proxy.value);
              var focus2 = unsafeGet(key5)(record);
              return " " + (key5 + (": " + (show1(focus2) + ("," + tail2))));
            };
          }
        };
      };
    ...
    append: function(v) {
      return function(v1) {
        ...
        if (v instanceof Plain && v1 instanceof Prefixed) {
          return new Prefixed(map4(second2(function(v2) {
            return v.value0 + v2;
          }))(v1.value0));
        }
        ;
  ...
  var isStringSize = {
    fromString: function($47) {
      return BasicSize.create(fromString3($47));
    }
  };
  var fromString12 = /* @__PURE__ */ fromString(isStringSize);
  var autoSize = {
    auto: /* @__PURE__ */ fromString12("auto")
  };
  ...
  var applicativeWriterT = function(dictMonoid) {
    ...
    return function(dictApplicative) {
      ...
      return {
        pure: function(a2) {
          return pure10(new Tuple(a2, mempty2));
        },
        Apply0: function() {
          return applyWriterT2;
        }
  ...
  var backgroundColor$prime = {
    background: /* @__PURE__ */ key2(/* @__PURE__ */ fromString13("background")),
    Val0: function() {
      return valColor;
    }
  };
  ...
  var display = /* @__PURE__ */ key(valDisplay)(/* @__PURE__ */ fromString4("display"));
  var block = /* @__PURE__ */ fromString14("block");
  ...
  var padding = function(a2) {
    return function(b2) {
      return function(c) {
        return function(d) {
          return key1(fromString5("padding"))(new Tuple(new Tuple(a2, b2), new Tuple(c, d)));
        };
      };
    };
  };
  var marginTop = /* @__PURE__ */ key3(/* @__PURE__ */ fromString5("margin-top"));
  var marginRight = /* @__PURE__ */ key3(/* @__PURE__ */ fromString5("margin-right"));
  var marginLeft = /* @__PURE__ */ key3(/* @__PURE__ */ fromString5("margin-left"));
  var marginBottom = /* @__PURE__ */ key3(/* @__PURE__ */ fromString5("margin-bottom"));
  var margin = function(a2) {
    return function(b2) {
      return function(c) {
        return function(d) {
          return key1(fromString5("margin"))(new Tuple(new Tuple(a2, b2), new Tuple(c, d)));
        };
      };
    };
  };
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Keyed) {
        return new Keyed(v2.value0, v2.value1, v.value0(v2.value2), map7(map13(go2))(v2.value3));
      }
      ;
      ...
      return function(f) {
        return makeEmitter(function(push2) {
          return function __do2() {
            ...
            addEventListener2(eventType)(listener)(false)(target5)();
            return removeEventListener2(eventType)(listener)(false)(target5);
          };
        });
      };
    };
  ...
  var auto2 = /* @__PURE__ */ auto(autoSize);
  ...
  var for_2 = /* @__PURE__ */ for_(applicativeEffect)(foldableMap);
  var pure5 = /* @__PURE__ */ pure(applicativeEffect);
  var liftEffect1 = /* @__PURE__ */ liftEffect(monadEffectEffect);
  var bindFlipped4 = /* @__PURE__ */ bindFlipped(bindEffect);
  var bindFlipped1 = /* @__PURE__ */ bindFlipped(bindMaybe);
  var bind22 = /* @__PURE__ */ bind(bindHalogenM);
  var discard5 = /* @__PURE__ */ discard2(bindHalogenM);
  var map16 = /* @__PURE__ */ map(functorMaybe);
  var bindFlipped22 = /* @__PURE__ */ bindFlipped(bindHalogenM);
  ...
  var timer = function(dictMonadAff) {
    ...
    return function(val) {
      return bind32(liftEffect22(create))(function(v) {
        return bind32(liftAff2(forkAff(forever2(discard1(delay(10))(function() {
  ...
  var genericBrickStatus = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 73, column 1 - line 73, column 60): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  })(showRecordFieldsCons2)(showInt))(showBoolean))(showNumber))(showBoolean))(showNumber))(showNumber))(/* @__PURE__ */ showMap(showBricksIndex)(showBrick))));
  var eqBrickStatus = {
    eq: function(x) {
      return function(y) {
  ...
  var render2 = function(state3) {
    return main([style2(discard22(margin(px(0))(px(0))(px(0))(px(0)))(function() {
      return padding(px(0))(px(0))(px(0))(px(0));
    }))])([canvas([style2(discard22(background2(rgb(238)(238)(238)))(function() {
      return discard22(display(block))(function() {
        return discard22(marginTop(px(0)))(function() {
          return discard22(marginRight(auto2))(function() {
            return discard22(marginBottom(px(0)))(function() {
              return marginLeft(auto2);
            });
          });
        });
      });
    })), id2(canvasId), width(480), height(320)]), text(show4(state3.dataset))]);
  };
  var brickWidth = 75;
  var brickRowCount = 3;
  var brickPadding = 10;
  ...
  var nextDataset = function(v) {
    return function(c) {
      var nextPaddleX = clamp3(0)(c.width - paddleWidth)(function() {
        var $196 = {
          left: v.leftPressed,
          right: v.rightPressed
        };
        if (!$196.left && $196.right) {
          return v.paddleX + 7;
        }
        ;
        if ($196.left && !$196.right) {
      ...
      var nextDyAndGameset = function(collisioned) {
        var touchTheFloor = v.y + v.dy > c.height - ballRadius;
        var touchThePaddle = touchTheFloor && between2(v.paddleX)(v.paddleX + paddleWidth)(v.x + v.dx);
        var touchTheCeiling = v.y + v.dy < ballRadius;
        if (touchTheCeiling) {
          return {
            nextDy: -v.dy,
            gameset: OnGame.value
          };
        }
        ;
        if (touchThePaddle) {
        ...
        ;
        throw new Error("Failed pattern match at Breakout (line 440, column 7 - line 446, column 57): " + [true]);
      };
      var nextDx = function() {
        var $202 = between2(ballRadius)(c.width - ballRadius)(v.x + v.dx);
        if ($202) {
          return v.dx;
        }
        ;
      ...
      var collisionDetection = function(ball) {
        return function(bricks) {
          ...
          var collisioned = function(v12) {
            return function(v2) {
              if (v2.status instanceof InActive) {
                return false;
              }
              ;
              if (v2.status instanceof Active) {
                if (between2(v2.x)(v2.x + toNumber(brickWidth))(ball.x) && between2(v2.y)(v2.y + toNumber(brickHeight))(ball.y)) {
                  return true;
                }
                ;
                if (otherwise) {
              ...
              ;
              throw new Error("Failed pattern match at Breakout (line 463, column 35 - line 468, column 29): " + [v2.status.constructor.name]);
            };
          };
          return head(map15(inactivate)(toUnfoldableUnordered2(filterWithKey2(collisioned)(bricks))));
        };
      };
      var nextBricksAndCollisioned = function() {
        var v12 = collisionDetection({
          x: v.x,
          y: v.y
        })(v.bricks);
        ...
        if (v12 instanceof Just) {
          return {
            nextBricks: insert4(v12.value0.value0)(v12.value0.value1)(v.bricks),
            collisioned: true
          };
        }
        ;
        throw new Error("Failed pattern match at Breakout (line 414, column 30 - line 422, column 8): " + [v12.constructor.name]);
      }();
      var v1 = nextDyAndGameset(nextBricksAndCollisioned.collisioned);
      var nextScore = function() {
        if (nextBricksAndCollisioned.collisioned) {
          return v.score + 1 | 0;
        }
        ;
        return v.score;
      ...
      var nextGameSet = function() {
        if (v1.gameset instanceof OnGame && nextScore === (brickRowCount * brickColumnCount | 0)) {
          return GameClear.value;
        }
        ;
        return v1.gameset;
      }();
      return {
        nextDataset: {
          ...
          bricks: nextBricksAndCollisioned.nextBricks,
          score: nextScore
        },
        gameset: nextGameSet
      };
    ...
    return function(dataset) {
      var drawScore = function(score) {
        return function __do2() {
          ...
          return fillText(ctx)("Score: " + toStringAs(decimal)(score))(8)(20)();
        };
      };
      ...
      var drawBricks = function(bricks) {
        return for_2(bricks)(function(v) {
        ...
        return function __do2() {
          ...
          forST(0)(brickColumnCount)(function(c) {
            return forST(0)(brickRowCount)(function(r) {
              ...
              var value14 = coord(Active.value)(key5);
              return modify2(insertWith2(modify5)(key5)(value14))($$var2);
            });
          })();
          return $$var2.value;
        }();
      ...
      return function __do2() {
        var dim = liftEffect1(getCanvasDimensions(canvas2))();
        var ctx = getContext2D(canvas2)();
        clearRect(ctx)({
          x: 0,
          y: 0,
        ...
        var bricks = coordinateBricks(dataset.bricks);
        drawBricks(bricks)();
        return nextDataset({
          x: dataset.x,
          y: dataset.y,
          dx: dataset.dx,
          dy: dataset.dy,
          paddleX: dataset.paddleX,
          leftPressed: dataset.leftPressed,
          rightPressed: dataset.rightPressed,
          bricks,
          score: dataset.score
        })(dim);
      };
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function __do2() {
      var v = getCanvasElementById(canvasId)();
      if (v instanceof Nothing) {
        return initialState(unit);
      }
      ;
      if (v instanceof Just) {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 255, column 11 - line 273, column 16): " + [v.constructor.name]);
    };
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind22(liftEffect22(bindFlipped4(document2)(windowImpl)))(function(document3) {
          return discard5(subscribe$prime(function(v1) {
            return eventListener2(keydown)(toEventTarget(document3))(function() {
              var $290 = map16(HandleKeyDown.create);
              return function($291) {
                return $290(fromEvent($291));
              };
            }());
          }))(function() {
            return discard5(subscribe$prime(function(v1) {
              return eventListener2(keyup)(toEventTarget(document3))(function() {
                var $292 = map16(HandleKeyUp.create);
                return function($293) {
                  return $292(fromEvent($293));
                };
              }());
            }))(function() {
              return discard5(subscribe$prime(function(v1) {
                return eventListener2(mousemove)(toEventTarget(document3))(function() {
                  var $294 = map16(HandleMouseMove.create);
                  return function($295) {
                    return $294(fromEvent2($295));
                  };
                }());
              }))(function() {
                return bind22(bindFlipped22(subscribe2)(timer1(Tick.value)))(function(sid) {
                  return bind22(liftEffect22(initialize))(function(init3) {
                    return put2({
                      maybeTimer: new Just(sid),
      ...
      if (v instanceof Tick) {
        return bind22(get2)(function(v1) {
          ...
          if ($238.a instanceof Just && $238.b instanceof Just) {
            return bind22(liftEffect22(draw($238.a.value0)(v1.dataset)))(function(ret) {
              if (ret.gameset instanceof GameOver) {
                return discard5(liftEffect22(bindFlipped4(alert("GAME OVER"))(windowImpl)))(function() {
                  return discard5(unsubscribe2($238.b.value0))(function() {
                    return liftEffect22(bindFlipped4(reload)(bindFlipped4(location)(windowImpl)));
                  });
                });
              }
              ;
              if (ret.gameset instanceof GameClear) {
                return discard5(liftEffect22(bindFlipped4(alert("YOU WIN, CONGRATULATIONS!"))(windowImpl)))(function() {
                  return discard5(unsubscribe2($238.b.value0))(function() {
                    return liftEffect22(bindFlipped4(reload)(bindFlipped4(location)(windowImpl)));
                  });
                });
              ...
              if (ret.gameset instanceof OnGame) {
                return modify_3(function(st) {
                  ...
                  ;
                  $240.dataset = ret.nextDataset;
                  return $240;
                });
              }
              ;
              throw new Error("Failed pattern match at Breakout (line 210, column 9 - line 219, column 70): " + [ret.gameset.constructor.name]);
            });
          }
          ;
          return pure1(unit);
      ...
      if (v instanceof HandleKeyDown) {
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              var $250 = {};
              for (var $251 in st) {
              ...
              ;
              $250.dataset = function() {
                var $247 = {};
                for (var $248 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $248)) {
                    $247[$248] = st["dataset"][$248];
                  }
                  ;
                }
                ;
                $247.rightPressed = true;
                return $247;
              }();
              return $250;
            });
        ...
        ;
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              var $256 = {};
              for (var $257 in st) {
              ...
              ;
              $256.dataset = function() {
                var $253 = {};
                for (var $254 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $254)) {
                    $253[$254] = st["dataset"][$254];
                  }
                  ;
                }
                ;
                $253.leftPressed = true;
                return $253;
              }();
              return $256;
            });
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $263.dataset = function() {
                var $260 = {};
                for (var $261 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $261)) {
                    $260[$261] = st["dataset"][$261];
                  }
                  ;
                }
                ;
                $260.rightPressed = false;
                return $260;
              }();
              return $263;
            });
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $269.dataset = function() {
                var $266 = {};
                for (var $267 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $267)) {
                    $266[$267] = st["dataset"][$267];
                  }
                  ;
                }
                ;
                $266.leftPressed = false;
                return $266;
              }();
              return $269;
            });
      ...
      if (v instanceof HandleMouseMove) {
        return bind22(get2)(function(v1) {
          return bind22(liftEffect22(htmlElementById(canvasId)))(function(maybeCanvasElement) {
            var v2 = new Tuple(v1.maybeCanvas, maybeCanvasElement);
            if (v2.value0 instanceof Just && v2.value1 instanceof Just) {
              return bind22(liftEffect22(getCanvasDimensions(v2.value0.value0)))(function(v3) {
                return bind22(liftEffect22(offsetLeft(v2.value1.value0)))(function(offsetLeft2) {
                  var relativeX = toNumber(clientX(v.value0)) - offsetLeft2;
                  var $276 = between2(0)(v3.width)(relativeX);
                  if ($276) {
                    return modify_3(function(st) {
                      var $280 = {};
                      for (var $281 in st) {
                      ...
                      ;
                      $280.dataset = function() {
                        var $277 = {};
                        for (var $278 in st.dataset) {
                          if ({}.hasOwnProperty.call(st.dataset, $278)) {
                            $277[$278] = st["dataset"][$278];
                          }
                          ;
                        }
                        ;
                        $277.paddleX = relativeX - paddleWidth / 2;
                        return $277;
                      }();
                      return $280;
                    });
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 180, column 16 - line 250, column 21): " + [v.constructor.name]);
    };
  };
  ...
  var selectElement = function(query2) {
    return bind5(liftEffect4(bindFlipped5(composeKleisliFlipped2(function() {
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect5(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind12(liftEffect5(read(ref2)))(function(v2) {
                    return discard12(liftEffect5(modify_(map22(insert5(sid)(finalize)))(v2.subscriptions)))(function() {
                    ...
                    var $$var2 = function() {
                        ...
                        unDriverStateX(function(st) {
                          return function __do3() {
                            flip(write)(st.handlerRef)(function() {
                              var $64 = maybe(pure13(unit))(handler2);
                              return function($65) {
                      ...
                      if (childrenIn instanceof Nothing) {
                        return runComponent(lchs)(function() {
                          var $66 = maybe(pure13(unit))(handler2);
                          return function($67) {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element4) {
        return bind14(liftEffect7(map23(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
