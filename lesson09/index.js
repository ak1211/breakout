...
(function($PS) {
  ...
  var timer = function (dictMonadAff) {
      return function (val) {
          return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())(Halogen_Subscription.create))(function (v) {
              return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Aff_Class.liftAff(dictMonadAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(10.0))(function () {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Halogen_Subscription.notify(v.listener)(val));
              })))))(function () {
  ...
  var initialState = function (v) {
      return {
          ...
          maybeTimer: Data_Maybe.Nothing.value,
          dataset: {
              x: 0.0,
              y: 0.0,
              dx: 0.0,
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.main([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0)))(function () {
          return CSS_Geometry.padding(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0));
      })) ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.background(CSS_Background["backgroundColor'"])(Color.rgb(238)(238)(238)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.block))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.px(0.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginRight(CSS_Common.auto(CSS_Size.autoSize)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginBottom(CSS_Size.px(0.0)))(function () {
                          return CSS_Geometry.marginLeft(CSS_Common.auto(CSS_Size.autoSize));
                      });
                  });
              });
          });
      })), Halogen_HTML_Properties.id(canvasId), Halogen_HTML_Properties.width(480), Halogen_HTML_Properties.height(320) ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
          reflectSymbol: function () {
              return "bricks";
          }
      })(Data_Show.showRecordFieldsCons({
      ...
      })(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showNumber))(Data_Show.showInt))(Data_Show.showBoolean))(Data_Show.showNumber))(Data_Show.showBoolean))(Data_Show.showNumber))(Data_Show.showNumber))(Data_Map_Internal.showMap(showBricksIndex)(showBrick))))(state.dataset)) ]);
  };
  var brickWidth = 75;
  var brickRowCount = 3;
  var brickPadding = 10;
  ...
  var nextDataset = function (v) {
      return function (c) {
          var nextPaddleX = Data_Ord.clamp(Data_Ord.ordNumber)(0.0)(c.width - paddleWidth)((function () {
              var $51 = {
                  left: v.leftPressed,
          ...
          var nextDyAndGameset = function (collisioned) {
              ...
              var touchThePaddle = touchTheFloor && Data_Ord.between(Data_Ord.ordNumber)(v.paddleX)(v.paddleX + paddleWidth)(v.x + v.dx);
              ...
              throw new Error("Failed pattern match at Breakout (line 439, column 7 - line 445, column 57): " + [ true ]);
          };
          var nextDx = (function () {
              var $57 = Data_Ord.between(Data_Ord.ordNumber)(ballRadius)(c.width - ballRadius)(v.x + v.dx);
              if ($57) {
                  return v.dx;
              };
              return -v.dx;
          ...
          var collisionDetection = function (ball) {
              return function (bricks) {
                  var inactivate = function (v1) {
                      return Data_Tuple.Tuple.create(v1.value0)({
                          x: v1.value1.x,
                          y: v1.value1.y,
                          status: InActive.value
                      });
                  };
                  var collisioned = function (v1) {
                      return function (v2) {
                          if (v2.status instanceof InActive) {
                              return false;
                          };
                          if (v2.status instanceof Active) {
                              if (Data_Ord.between(Data_Ord.ordNumber)(v2.x)(v2.x + Data_Int.toNumber(brickWidth))(ball.x) && Data_Ord.between(Data_Ord.ordNumber)(v2.y)(v2.y + Data_Int.toNumber(brickHeight))(ball.y)) {
                                  return true;
                              };
                              if (Data_Boolean.otherwise) {
                                  return false;
                          ...
                          throw new Error("Failed pattern match at Breakout (line 462, column 35 - line 467, column 29): " + [ v2.status.constructor.name ]);
                      };
                  };
                  return Data_Array.head(Data_Functor.map(Data_Functor.functorArray)(inactivate)(Data_Map_Internal.toUnfoldableUnordered(Data_Unfoldable.unfoldableArray)(Data_Map_Internal.filterWithKey(ordBricksIndex)(collisioned)(bricks))));
              };
          };
          var nextBricksAndCollisioned = (function () {
              var v1 = collisionDetection({
                  x: v.x,
                  y: v.y
              })(v.bricks);
              if (v1 instanceof Data_Maybe.Nothing) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return {
                      nextBricks: Data_Map_Internal.insert(ordBricksIndex)(v1.value0.value0)(v1.value0.value1)(v.bricks),
                      collisioned: true
                  };
              };
              throw new Error("Failed pattern match at Breakout (line 413, column 30 - line 421, column 8): " + [ v1.constructor.name ]);
          })();
      ...
      return function (dataset) {
          var drawScore = function (score) {
              return function __do() {
                  ...
                  return Graphics_Canvas.fillText(ctx)("Score: " + Data_Int.toStringAs(Data_Int.decimal)(score))(8.0)(20.0)();
              };
          };
          ...
          var drawBricks = function (bricks) {
              return Data_Foldable.for_(Effect.applicativeEffect)(Data_Map_Internal.foldableMap)(bricks)(function (v) {
  ...
  var handleAction = function (dictMonadAff) {
      var initialize = function __do() {
          ...
          if (v instanceof Data_Maybe.Nothing) {
              return initialState(Data_Unit.unit);
          };
          if (v instanceof Data_Maybe.Just) {
              var dim = Graphics_Canvas.getCanvasDimensions(v.value0)();
              return {
      ...
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                      return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                          var $145 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create);
                          return function ($146) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                          return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                              var $147 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create);
                              return function ($148) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                              return Halogen_Query_Event.eventListener(Web_UIEvent_MouseEvent_EventTypes.mousemove)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                  var $149 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleMouseMove.create);
                                  return function ($150) {
                                      return $149(Web_UIEvent_MouseEvent.fromEvent($150));
                                  };
                              })());
                          }))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bindFlipped(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe)(timer(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Tick.value)))(function (sid) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(initialize))(function (init) {
                                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                                          maybeTimer: new Data_Maybe.Just(sid),
          ...
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  if ($93.a instanceof Data_Maybe.Just && $93.b instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(draw($93.a.value0)(v1.dataset)))(function (ret) {
                          if (ret.gameset instanceof GameOver) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.alert("GAME OVER"))(Web_HTML.window)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe($93.b.value0))(function () {
                                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Location.reload)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.location)(Web_HTML.window)));
                                  });
                              });
                          };
                          if (ret.gameset instanceof GameClear) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.alert("YOU WIN, CONGRATULATIONS!"))(Web_HTML.window)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe($93.b.value0))(function () {
                                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Location.reload)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.location)(Web_HTML.window)));
                                  });
                              });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $105.dataset = (function () {
                              var $102 = {};
                              for (var $103 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $103)) {
                                      $102[$103] = st["dataset"][$103];
                                  };
                              };
                              $102.rightPressed = true;
                              return $102;
                          })();
                          return $105;
                      });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Left" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowLeft") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $111.dataset = (function () {
                              var $108 = {};
                              for (var $109 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $109)) {
                                      $108[$109] = st["dataset"][$109];
                                  };
                              };
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $118.dataset = (function () {
                              var $115 = {};
                              for (var $116 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $116)) {
                                      $115[$116] = st["dataset"][$116];
                                  };
                              };
          ...
          if (v instanceof HandleMouseMove) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(htmlElementById(canvasId)))(function (maybeCanvasElement) {
                      var v2 = new Data_Tuple.Tuple(v1.maybeCanvas, maybeCanvasElement);
                      if (v2.value0 instanceof Data_Maybe.Just && v2.value1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Graphics_Canvas.getCanvasDimensions(v2.value0.value0)))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_HTML_HTMLElement.offsetLeft(v2.value1.value0)))(function (offsetLeft) {
                                  var relativeX = Data_Int.toNumber(Web_UIEvent_MouseEvent.clientX(v.value0)) - offsetLeft;
                                  var $131 = Data_Ord.between(Data_Ord.ordNumber)(0.0)(v3.width)(relativeX);
                                  if ($131) {
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                          var $135 = {};
                                          for (var $136 in st) {
                                          ...
                                          $135.dataset = (function () {
                                              ...
                                              $132.paddleX = relativeX - paddleWidth / 2.0;
                                              return $132;
                                          })();
                                          return $135;
                                      });
