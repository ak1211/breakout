(() => {
  // output/Breakout/foreign.js
  var showModalDialogImpl = function(target6) {
    $("#" + target6).modal("show");
  };
  var hideModalDialogImpl = function(target6) {
    $("#" + target6).modal("hide");
  };
            ...
            eqRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  ...
                  var key4 = reflectSymbol2($$Proxy.value);
                  var get3 = unsafeGet(key4);
          ...
          return {
            compareRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  var key4 = reflectSymbol2($$Proxy.value);
                  var left = compare3(unsafeGet(key4)(ra))(unsafeGet(key4)(rb));
        ...
        return {
          showRecordFields: function(v) {
            return function(record) {
              ...
              var key4 = reflectSymbol2($$Proxy.value);
              var focus3 = unsafeGet(key4)(record);
              return " " + (key4 + (": " + (show1(focus3) + ("," + tail2))));
            };
          }
        };
      };
  ...
  var showTuple = function(dictShow) {
    ...
    return function(dictShow1) {
      ...
      return {
        show: function(v) {
          return "(Tuple " + (show5(v.value0) + (" " + (show1(v.value1) + ")")));
        }
      };
    };
  };
      ...
      return function(map23) {
        return function(f) {
          var buildFrom = function(x, ys) {
            return apply3(map23(consList)(f(x)))(ys);
          };
  ...
  var key = function(dictVal) {
    var value13 = value(dictVal);
    return function(k) {
      return function(v) {
        return rule(new Property(cast(k), value13(v)));
      };
    };
  };
  var functorStyleM = {
  ...
  var backgroundColor$prime = {
    background: /* @__PURE__ */ key2(/* @__PURE__ */ fromString12("background")),
    Val0: function() {
      return valColor;
    }
  };
      ...
      var go2 = function($copy_v) {
        ...
        function $tco_loop(v) {
          ...
          if (v instanceof Cons) {
            ...
            if (v.value0 instanceof Three) {
              $tco_done = true;
              return new Just(new Tuple(new Tuple(v.value0.value1, v.value0.value2), new Cons(singleton5(v.value0.value4)(v.value0.value5), new Cons(v.value0.value0, new Cons(v.value0.value3, new Cons(v.value0.value6, v.value1))))));
            }
            ;
  ...
  var showMap = function(dictShow) {
    ...
    return function(dictShow1) {
      var show5 = show(showArray(showTuple2(dictShow1)));
      return {
        show: function(m) {
          return "(fromFoldable " + (show5(toAscArray(m)) + ")");
        }
      };
    };
  };
  ...
  var h5 = /* @__PURE__ */ element3("h5");
  var hr = function(props) {
    return element3("hr")(props)([]);
  };
  ...
  function cancelAnimationFrame(id3) {
    return function(window2) {
      return function() {
        return window2.cancelAnimationFrame(id3);
      };
    };
  }
  ...
  var traverse_5 = /* @__PURE__ */ traverse_(applicativeEffect);
  var traverse_12 = /* @__PURE__ */ traverse_5(foldableMaybe);
  var discard22 = /* @__PURE__ */ discard2(bindStyleM);
  var background2 = /* @__PURE__ */ background(backgroundColor$prime);
  ...
  var traverse_22 = /* @__PURE__ */ traverse_5(foldableMap);
  var bind22 = /* @__PURE__ */ bind(bindHalogenM);
  var discard4 = /* @__PURE__ */ discard2(bindHalogenM);
  ...
  var OnGame = /* @__PURE__ */ function() {
    function OnGame2() {
    }
    ;
    OnGame2.value = new OnGame2();
    return OnGame2;
  }();
  var RespawnGame = /* @__PURE__ */ function() {
    function RespawnGame2() {
    }
    ;
    RespawnGame2.value = new RespawnGame2();
    return RespawnGame2;
  }();
  var GameOver = /* @__PURE__ */ function() {
    ...
    ;
    GameOver2.value = new GameOver2();
    return GameOver2;
  }();
  var GameClear = /* @__PURE__ */ function() {
    function GameClear2() {
    }
    ;
    GameClear2.value = new GameClear2();
    return GameClear2;
  }();
  ...
  var HandleMouseMove = /* @__PURE__ */ function() {
    function HandleMouseMove2(value0) {
      this.value0 = value0;
    }
    ;
    HandleMouseMove2.create = function(value0) {
      return new HandleMouseMove2(value0);
    };
    return HandleMouseMove2;
  }();
  var HandleAnimationFrame = /* @__PURE__ */ function() {
    function HandleAnimationFrame2() {
    }
    ;
    HandleAnimationFrame2.value = new HandleAnimationFrame2();
    return HandleAnimationFrame2;
  }();
  ...
  var HandleKeyUp = /* @__PURE__ */ function() {
    function HandleKeyUp2(value0) {
      this.value0 = value0;
    }
    ;
    HandleKeyUp2.create = function(value0) {
      return new HandleKeyUp2(value0);
    };
    return HandleKeyUp2;
  }();
  var HandleDialogCloseButton = /* @__PURE__ */ function() {
    function HandleDialogCloseButton2(value0) {
      this.value0 = value0;
    }
    ;
    HandleDialogCloseButton2.create = function(value0) {
      return new HandleDialogCloseButton2(value0);
    };
    return HandleDialogCloseButton2;
  }();
  var toStringScore = function(v) {
    return toStringAs(decimal)(v);
  };
  var toStringLives = function(v) {
    return toStringAs(decimal)(v);
  };
  var showScore = showInt;
  var showModalDialog = /* @__PURE__ */ runEffectFn1(showModalDialogImpl);
  var showLives = showInt;
  var showBricksIndex = /* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons(columnIsSymbol)(/* @__PURE__ */ showRecordFieldsConsNil(rowIsSymbol)(showInt))(showInt));
  var raiseToScore = function(v) {
    return v + 1 | 0;
  };
  var paddleWidth = 75;
  var respawnDataset = function(canvas2) {
    return function(ds) {
      return function __do2() {
        var dim = getCanvasDimensions(canvas2)();
        return {
          x: dim.width / 2,
          y: dim.height - 30,
          dx: 2,
          dy: -2,
          paddleX: (dim.width - paddleWidth) / 2,
          bricks: ds.bricks,
          leftPressed: ds.leftPressed,
          lives: ds.lives,
          mouseMoved: ds.mouseMoved,
          mousePointClientX: ds.mousePointClientX,
          rightPressed: ds.rightPressed,
          score: ds.score
        };
      };
    };
  ...
  var paddleHeight = 10;
  var ordBricksIndex = /* @__PURE__ */ ordRecord()(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(ordRecordNil)()(rowIsSymbol)(ordInt))()(columnIsSymbol)(ordInt));
  var filterWithKey2 = /* @__PURE__ */ filterWithKey(ordBricksIndex);
  var insertWith2 = /* @__PURE__ */ insertWith(ordBricksIndex);
  var insert4 = /* @__PURE__ */ insert2(ordBricksIndex);
  var modalDialog2 = function(input3) {
    return div2([classes([modal, fade, show3]), id2(input3.modalId), tabIndex(-1 | 0), attr2("role")("dialog"), attr2("data-backdrop")("static"), onKeyDown(function(v) {
      return new HandleDialogCloseButton(input3);
    })])([div2([classes([modalDialog, modalDialogCentered]), attr2("role")("document")])([div2([class_(modalContent)])([div2([class_(modalHeader)])([h5([class_(modalTitle)])([text(input3.title)]), button([class_(btnClose), type_19(ButtonButton.value), attr2("data-dismiss")("modal"), attr2("area-label")("Close"), onClick(function(v) {
      return new HandleDialogCloseButton(input3);
    })])([span3([attr2("area-hidden")("true")])([text("\xD7")])])]), div2([class_(modalBody)])([p_([text(input3.message)])]), div2([class_(modalFooter)])([button([classes([btn, btnPrimary]), type_19(ButtonButton.value), attr2("data-dismiss")("modal"), onClick(function(v) {
      return new HandleDialogCloseButton(input3);
    })])([text("Close")])])])])]);
  };
  var htmlElementById = function(elementId) {
    return function __do2() {
      var document3 = bindFlipped4(document2)(windowImpl)();
      var nonElementParentNode = toNonElementParentNode(document3);
      var element4 = getElementById(elementId)(nonElementParentNode)();
      return bindFlipped1(fromElement)(element4);
    };
  };
  var hideModalDialog = /* @__PURE__ */ runEffectFn1(hideModalDialogImpl);
  var genericBrickStatus = {
    to: function(x) {
      if (x instanceof Inl) {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 71, column 1 - line 71, column 60): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  var showBrickStatus = {
    show: /* @__PURE__ */ genericShow(genericBrickStatus)(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor2({
      reflectSymbol: function() {
        return "InActive";
      }
  ...
  var showBrick = /* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons({
    reflectSymbol: function() {
      return "status";
    }
  })(showRecordFieldsCons2)(showBrickStatus));
  var show4 = /* @__PURE__ */ show(/* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons({
    reflectSymbol: function() {
      return "bricks";
    }
  ...
  })(showRecordFieldsCons2)(showScore))(showBoolean))(showNumber))(showInt))(showBoolean))(showLives))(showBoolean))(showNumber))(showNumber))(/* @__PURE__ */ showMap(showBricksIndex)(showBrick))));
  var gameOverDialog = {
  ...
  var initialState = function(v) {
    return {
      maybeCanvas: Nothing.value,
      maybeEmitAnimationFrame: Nothing.value,
      dataset: {
        x: 0,
        y: 0,
        dx: 0,
  ...
  var eq22 = /* @__PURE__ */ eq(eqBrickStatus);
  var emitRequestAnimationFrame = function(val) {
    return makeEmitter(function(emitter) {
      return liftEffect3(function __do2() {
        var ref2 = $$new(Nothing.value)();
        var $lazy_loop = $runtime_lazy7("loop", "Breakout", function() {
          return function __do3() {
            emitter(val)();
            var animationId = bindFlipped4(requestAnimationFrame($lazy_loop(668)))(windowImpl)();
            return write(new Just(animationId))(ref2)();
          };
        });
        var loop2 = $lazy_loop(666);
        loop2();
        return bind5(read(ref2))(traverse_12(function(animationId) {
          return bind5(windowImpl)(cancelAnimationFrame(animationId));
        }));
      });
    });
  };
  var consumeLives = function(v) {
    if (1 < v) {
      return new Just(v - 1 | 0);
    }
    ;
    return Nothing.value;
  };
  ...
  var render2 = function(state3) {
    var headingOne = div2([classes([cardHeader, p0, dGrid, gap0]), id2("headingOne")])([button([classes([btn, btnOutlineInfo, col12]), type_19(ButtonButton.value), attr2("data-toggle")("collapse"), attr2("data-target")("#collapseOne"), attr2("area-controls")("collapseOne")])([text("\u3044\u307E\u306E\u72B6\u614B")])]);
    var greeting = div2([class_(col)])([h1([classes([display4, textCenter])])([text("BREAKOUT")]), hr([class_(my4)]), p([class_(lead)])([text("Use Arrow Keys or Mouse to play.")])]);
    var collapseOne = div2([classes([collapse]), id2("collapseOne"), attr2("area-labelledby")("headingOne"), attr2("data-parent")("#accordionExample"), attr2("area-expanded")("false")])([div2([class_(cardBody)])([text(show4(state3.dataset))])]);
    var accordion2 = div2([classes([col, accordion]), id2("accordionExample")])([div2([class_(card)])([headingOne, collapseOne]), div2([class_(card)])([])]);
    return main([class_(container)])([modalDialog2(gameClearDialog), modalDialog2(gameOverDialog), div2([class_(row)])([greeting]), div2([class_(row)])([accordion2]), div2([classes([row, justifyContentCenter])])([canvas([classes([m3, border, borderInfo]), style2(discard22(background2(rgb(238)(238)(238)))(function() {
  ...
  var brickHeight = 20;
  var collisionDetection = function(ball) {
    return function(bricks) {
      var inactivate = function(v) {
      ...
      var collidesBallAndBrick = function(v) {
        return function(v1) {
          if (v1.status instanceof InActive) {
            return false;
          }
          ;
          if (v1.status instanceof Active) {
            if (between2(v1.x)(v1.x + toNumber(brickWidth))(ball.x) && between2(v1.y)(v1.y + toNumber(brickHeight))(ball.y)) {
              return true;
            }
            ;
            if (otherwise) {
          ...
          ;
          throw new Error("Failed pattern match at Breakout (line 653, column 42 - line 658, column 27): " + [v1.status.constructor.name]);
        };
      };
      return map14(inactivate)(head(toUnfoldableUnordered2(filterWithKey2(collidesBallAndBrick)(bricks))));
    };
  };
  var brickColumnCount = 5;
  var coordinateBricks = function(bricks) {
    var modify5 = function(v) {
      return function(v1) {
        return {
          x: v1.x,
          y: v1.y,
    ...
    var coord = function(status) {
      return function(v) {
        return {
          x: toNumber((v.column * (brickWidth + brickPadding | 0) | 0) + brickOffsetLeft | 0),
          y: toNumber((v.row * (brickHeight + brickPadding | 0) | 0) + brickOffsetTop | 0),
          status
        };
      };
    };
    return function __do2() {
      ...
      forST(0)(brickColumnCount)(function(c) {
        return forST(0)(brickRowCount)(function(r) {
          var key4 = {
            row: r,
            column: c
          };
          var value13 = coord(Active.value)(key4);
          return modify2(insertWith2(modify5)(key4)(value13))($$var2);
        });
      })();
      return $$var2.value;
    }();
  };
  var totalBricks = /* @__PURE__ */ function() {
    return brickRowCount * brickColumnCount | 0;
  }();
  var reachThePassingScore = function(v) {
    return totalBricks === v;
  };
  var ballRadius = 10;
  var nextDataset = function(v) {
    return function(c) {
      return function(canvasElementOffsetLeft) {
        var updateBricks = function(v1) {
          return insert4(v1.value0)(v1.value1)(v.bricks);
        };
        var nextPaddleX = function() {
          var relativeX = toNumber(v.mousePointClientX) - canvasElementOffsetLeft;
          var cond = {
            left: v.leftPressed,
            right: v.rightPressed,
            mouseMoved: v.mouseMoved
          };
          return clamp3(0)(c.width - paddleWidth)(function() {
            ...
            ;
            if (cond.mouseMoved) {
              return relativeX - paddleWidth / 2;
            }
            ;
            return v.paddleX;
          }());
        }();
        var maybeCollisionedBrick = collisionDetection({
          x: v.x,
          y: v.y
        })(v.bricks);
        var nextBricks = maybe(v.bricks)(updateBricks)(maybeCollisionedBrick);
        var hitRightWall = v.x + v.dx > c.width - ballRadius;
        var hitLeftWall = v.x + v.dx < ballRadius;
        var nextDx = function() {
          var $237 = hitLeftWall || hitRightWall;
          if ($237) {
            return -v.dx;
          }
          ;
        ...
        var hitFloor = v.y + v.dy > c.height - ballRadius;
        var hitPaddle = hitFloor && between2(v.paddleX)(v.paddleX + paddleWidth)(v.x + v.dx);
        var hitCeiling = v.y + v.dy < ballRadius;
        var hitBrick = isJust(maybeCollisionedBrick);
        var nextDy = function() {
          if (hitCeiling) {
            return -v.dy;
          }
          ...
          ;
          throw new Error("Failed pattern match at Breakout (line 625, column 12 - line 630, column 24): " + [true]);
        }();
        var nextScore = function() {
          if (hitBrick) {
            return raiseToScore(v.score);
          }
          ;
          return v.score;
        }();
        var nextGameSetAndNextLives = function() {
          if (reachThePassingScore(nextScore)) {
            return {
              nextGameSet: GameClear.value,
              nextLives: v.lives
            };
          }
          ;
          if (hitFloor && !hitPaddle) {
            var v1 = consumeLives(v.lives);
            if (v1 instanceof Just) {
              return {
                nextGameSet: RespawnGame.value,
                nextLives: v1.value0
              };
            }
            ;
            if (v1 instanceof Nothing) {
              return {
                nextGameSet: GameOver.value,
                nextLives: v.lives
              };
            }
            ;
            throw new Error("Failed pattern match at Breakout (line 636, column 40 - line 638, column 71): " + [v1.constructor.name]);
          }
          ;
          if (otherwise) {
            return {
              nextGameSet: OnGame.value,
              nextLives: v.lives
            };
          }
          ;
          throw new Error("Failed pattern match at Breakout (line 633, column 29 - line 639, column 71): " + [true]);
        }();
        return {
          nextDataset: {
            x: v.x + v.dx,
            ...
            dy: nextDy,
            paddleX: nextPaddleX,
            leftPressed: v.leftPressed,
            rightPressed: v.rightPressed,
            mouseMoved: false,
            mousePointClientX: v.mousePointClientX,
            bricks: nextBricks,
            score: nextScore,
            lives: nextGameSetAndNextLives.nextLives
          },
          gameset: nextGameSetAndNextLives.nextGameSet
        };
      };
    };
  };
  var draw = function(canvas2) {
    return function(dataset) {
      var drawScore = function(v) {
        return function(score) {
          return function __do2() {
            var ctx = getContext2D(canvas2)();
            setFont(ctx)("16px Arial")();
            setFillStyle(ctx)("#0095DD")();
            return fillText(ctx)("Score: " + toStringScore(score))(8)(20)();
          };
        };
      };
      var drawPaddle = function(v) {
        return function __do2() {
          var ctx = getContext2D(canvas2)();
          beginPath(ctx)();
          rect(ctx)({
            x: dataset.paddleX,
            y: v.height - paddleHeight,
            width: paddleWidth,
            height: paddleHeight
          })();
          setFillStyle(ctx)("#0095DD")();
      ...
      var drawLives = function(v) {
        return function(lives) {
          return function __do2() {
            var ctx = getContext2D(canvas2)();
            setFont(ctx)("16px Arial")();
            setFillStyle(ctx)("#0095DD")();
            return fillText(ctx)("Lives: " + toStringLives(lives))(v.width - 65)(20)();
          };
        };
      };
      var drawBricks = traverse_22(function(v) {
        if (eq22(v.status)(Active.value)) {
          return function __do2() {
            var ctx = getContext2D(canvas2)();
            beginPath(ctx)();
            rect(ctx)({
              x: v.x,
              y: v.y,
              width: toNumber(brickWidth),
              height: toNumber(brickHeight)
            })();
            setFillStyle(ctx)("#0095DD")();
            fill(ctx)();
            return closePath(ctx)();
      ...
      var canvasElementOffsetLeft = function(elemId) {
        return function __do2() {
          var maybeCanvasElement = htmlElementById(elemId)();
          return maybe(pure5(0))(offsetLeft)(maybeCanvasElement)();
        };
      };
      return function __do2() {
        var dim = liftEffect3(getCanvasDimensions(canvas2))();
        var ctx = getContext2D(canvas2)();
        clearRect(ctx)({
          x: 0,
          y: 0,
        ...
        var offsetLeft2 = canvasElementOffsetLeft(canvasId)();
        return nextDataset(dataset)(dim)(offsetLeft2);
      };
    };
  };
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function() {
      var st = initialState(unit);
      return function __do2() {
        var v = getCanvasElementById(canvasId)();
        if (v instanceof Nothing) {
          return st;
        }
        ;
        if (v instanceof Just) {
          var respawnedDataset = respawnDataset(v.value0)(st.dataset)();
          var bricks = coordinateBricks(st.dataset.bricks);
          return {
            maybeCanvas: new Just(v.value0),
            dataset: {
              bricks,
              dx: respawnedDataset.dx,
              dy: respawnedDataset.dy,
              leftPressed: respawnedDataset.leftPressed,
              lives: respawnedDataset.lives,
              mouseMoved: respawnedDataset.mouseMoved,
              mousePointClientX: respawnedDataset.mousePointClientX,
              paddleX: respawnedDataset.paddleX,
              rightPressed: respawnedDataset.rightPressed,
              score: respawnedDataset.score,
              x: respawnedDataset.x,
              y: respawnedDataset.y
            },
            maybeEmitAnimationFrame: st.maybeEmitAnimationFrame
          };
        }
        ;
        throw new Error("Failed pattern match at Breakout (line 412, column 13 - line 422, column 22): " + [v.constructor.name]);
      };
    }();
    return function(v) {
      if (v instanceof Initialize2) {
        return bind22(liftEffect12(bindFlipped4(document2)(windowImpl)))(function(document3) {
          return discard4(subscribe$prime(function(v1) {
            return eventListener2(keydown)(toEventTarget(document3))(function() {
              var $304 = map14(HandleKeyDown.create);
              return function($305) {
                return $304(fromEvent($305));
              };
            }());
          }))(function() {
            return discard4(subscribe$prime(function(v1) {
              return eventListener2(keyup)(toEventTarget(document3))(function() {
                var $306 = map14(HandleKeyUp.create);
                return function($307) {
                  return $306(fromEvent($307));
                };
              }());
            }))(function() {
              return discard4(subscribe$prime(function(v1) {
                return eventListener2(mousemove)(toEventTarget(document3))(function() {
                  var $308 = map14(HandleMouseMove.create);
                  return function($309) {
                    return $308(fromEvent2($309));
                  };
                }());
              }))(function() {
                return bind22(subscribe2(emitRequestAnimationFrame(HandleAnimationFrame.value)))(function(sid) {
                  return bind22(liftEffect12(initialize))(function(init3) {
                    return put2({
                      maybeEmitAnimationFrame: new Just(sid),
                      dataset: init3.dataset,
                      maybeCanvas: init3.maybeCanvas
                    });
                  });
                });
              });
      ...
      if (v instanceof Finalize2) {
        return bind22(get2)(function(v1) {
          return maybe(mempty2)(unsubscribe2)(v1.maybeEmitAnimationFrame);
        });
      }
      ;
      if (v instanceof HandleAnimationFrame) {
        return bind22(get2)(function(v1) {
          if (v1.maybeCanvas instanceof Just) {
            return bind22(liftEffect12(draw(v1.maybeCanvas.value0)(v1.dataset)))(function(ret) {
              if (ret.gameset instanceof GameOver) {
                return liftEffect12(showModalDialog(gameOverDialog.modalId));
              }
              ;
              if (ret.gameset instanceof GameClear) {
                return liftEffect12(showModalDialog(gameClearDialog.modalId));
              }
              ;
              if (ret.gameset instanceof RespawnGame) {
                return bind22(liftEffect12(respawnDataset(v1.maybeCanvas.value0)(ret.nextDataset)))(function(respawndData) {
                  return modify_3(function(st) {
                    ...
                    ;
                    $263.dataset = respawndData;
                    return $263;
                  });
                });
              }
              ;
              if (ret.gameset instanceof OnGame) {
                return modify_3(function(st) {
                  var $266 = {};
                  for (var $267 in st) {
                    if ({}.hasOwnProperty.call(st, $267)) {
                      $266[$267] = st[$267];
                    }
                    ;
                  }
                  ;
                  $266.dataset = ret.nextDataset;
                  return $266;
                });
              }
              ;
              throw new Error("Failed pattern match at Breakout (line 371, column 9 - line 377, column 70): " + [ret.gameset.constructor.name]);
            });
          }
          ;
          return pure1(unit);
      ...
      if (v instanceof HandleKeyDown) {
        if (key3(v.value0) === "Right" || key3(v.value0) === "ArrowRight") {
          return discard4(liftEffect12(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              var $273 = {};
              for (var $274 in st) {
              ...
              ;
              $273.dataset = function() {
                var $270 = {};
                for (var $271 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $271)) {
                    $270[$271] = st["dataset"][$271];
                  }
                  ;
                }
                ;
                $270.rightPressed = true;
                return $270;
              }();
              return $273;
            });
        ...
        ;
        if (key3(v.value0) === "Left" || key3(v.value0) === "ArrowLeft") {
          return discard4(liftEffect12(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              var $279 = {};
              for (var $280 in st) {
              ...
              ;
              $279.dataset = function() {
                var $276 = {};
                for (var $277 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $277)) {
                    $276[$277] = st["dataset"][$277];
                  }
                  ;
                }
                ;
                $276.leftPressed = true;
                return $276;
              }();
              return $279;
            });
        ...
        if (key3(v.value0) === "Right" || key3(v.value0) === "ArrowRight") {
          return discard4(liftEffect12(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              var $286 = {};
              for (var $287 in st) {
                if ({}.hasOwnProperty.call(st, $287)) {
                  $286[$287] = st[$287];
                }
                ;
              }
              ;
              $286.dataset = function() {
                var $283 = {};
                for (var $284 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $284)) {
                    $283[$284] = st["dataset"][$284];
                  }
                  ;
                }
                ;
                $283.rightPressed = false;
                return $283;
              }();
              return $286;
            });
        ...
        if (key3(v.value0) === "Left" || key3(v.value0) === "ArrowLeft") {
          return discard4(liftEffect12(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              var $292 = {};
              for (var $293 in st) {
                if ({}.hasOwnProperty.call(st, $293)) {
                  $292[$293] = st[$293];
                }
                ;
              }
              ;
              $292.dataset = function() {
                var $289 = {};
                for (var $290 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $290)) {
                    $289[$290] = st["dataset"][$290];
                  }
                  ;
                }
                ;
                $289.leftPressed = false;
                return $289;
              }();
              return $292;
            });
      ...
      if (v instanceof HandleMouseMove) {
        return modify_3(function(st) {
          var $299 = {};
          for (var $300 in st) {
            if ({}.hasOwnProperty.call(st, $300)) {
              $299[$300] = st[$300];
            }
            ;
          }
          ;
          $299.dataset = function() {
            var $296 = {};
            for (var $297 in st.dataset) {
              if ({}.hasOwnProperty.call(st.dataset, $297)) {
                $296[$297] = st["dataset"][$297];
              }
              ;
            }
            ;
            $296.mouseMoved = true;
            $296.mousePointClientX = clientX(v.value0);
            return $296;
          }();
          return $299;
        });
      ...
      ;
      if (v instanceof HandleDialogCloseButton) {
        return discard4(liftEffect12(hideModalDialog(v.value0.modalId)))(function() {
          return bind22(liftEffect12(initialize))(function(init3) {
            return put2(init3);
          });
        });
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 338, column 16 - line 404, column 15): " + [v.constructor.name]);
    };
  };
  ...
  var selectElement = function(query2) {
    return bind6(liftEffect4(bindFlipped5(composeKleisliFlipped2(function() {
      ...
      return pure6(bindFlipped12(fromElement)(mel));
    });
  };
  ...
  var awaitLoad = /* @__PURE__ */ makeAff(function(callback) {
    return function __do2() {
      ...
      if (rs instanceof Loading) {
        var et = map15(toEventTarget2)(windowImpl)();
  ...
  var unsubscribe3 = function(sid) {
    return function(ref2) {
      return function __do2() {
        ...
        return traverse_6(unsubscribe)(bindFlipped6(lookup6(sid))(subs))();
      };
    };
  };
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect5(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind12(liftEffect5(read(ref2)))(function(v2) {
                    return discard1(liftEffect5(modify_(map22(insert5(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  var cleanupSubscriptionsAndForks = function(v) {
    return function __do2() {
      bindFlipped7(traverse_24(traverse_33(unsubscribe)))(read(v.subscriptions))();
            ...
            return function(v1) {
              if (v1 instanceof Nothing) {
                return function __do2() {
                  ...
                  $$void7(appendChild(node)(toNode2(container2)))();
                  return {
                    machine,
                    node,
                    renderChildRef
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element4) {
        return bind14(liftEffect7(map21(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
