(() => {
    ...
    return function(dataset) {
      var nextDataset = function(c) {
        ...
        return {
          ...
          dx: function() {
            var $102 = between2(0 + ballRadius)(c.width - ballRadius)(dataset.x + dataset.dx);
            if ($102) {
              return dataset.dx;
            }
            ;
          ...
          dy: function() {
            var $103 = between2(0 + ballRadius)(c.height - ballRadius)(dataset.y + dataset.dy);
            if ($103) {
              return dataset.dy;
            }
            ;
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function __do2() {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 154, column 11 - line 169, column 16): " + [v.constructor.name]);
    };
    return function(v) {
      if (v instanceof Initialize2) {
        return bind12(liftEffect22(initialize))(function(init3) {
          return discard4(put2(init3))(function() {
            return bind12(liftEffect22(bindFlipped4(document2)(windowImpl)))(function(document3) {
              return discard4(subscribe$prime(function(v1) {
                return eventListener2(keydown)(toEventTarget(document3))(function() {
                  var $145 = map11(HandleKeyDown.create);
                  return function($146) {
                    return $145(fromEvent($146));
                  };
                }());
              }))(function() {
                return discard4(subscribe$prime(function(v1) {
                  return eventListener2(keyup)(toEventTarget(document3))(function() {
                    var $147 = map11(HandleKeyUp.create);
                    return function($148) {
                      return $147(fromEvent($148));
                    };
                  }());
                }))(function() {
                  return bind12(bindFlipped1(subscribe2)(timer1(Tick.value)))(function() {
                    return pure1(unit);
                  });
                });
              });
      ...
      if (v instanceof Tick) {
        return bind12(get2)(function(v1) {
          if (v1.maybeCanvas instanceof Nothing) {
            return pure1(unit);
          }
          ;
          if (v1.maybeCanvas instanceof Just) {
            return bind12(liftEffect22(draw(v1.maybeCanvas.value0)(v1.dataset)))(function(newDataset) {
              return modify_3(function(st) {
                ...
                ;
                $115.dataset = newDataset;
                return $115;
              });
            });
          }
          ;
          throw new Error("Failed pattern match at Breakout (line 129, column 5 - line 133, column 53): " + [v1.maybeCanvas.constructor.name]);
        });
      }
      ;
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $122.dataset = function() {
                var $119 = {};
                for (var $120 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $120)) {
                    $119[$120] = st["dataset"][$120];
                  }
                  ;
                }
                ;
                $119.rightPressed = true;
                return $119;
              }();
              return $122;
            });
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $128.dataset = function() {
                var $125 = {};
                for (var $126 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $126)) {
                    $125[$126] = st["dataset"][$126];
                  }
                  ;
                }
                ;
                $125.leftPressed = true;
                return $125;
              }();
              return $128;
            });
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $135.dataset = function() {
                var $132 = {};
                for (var $133 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $133)) {
                    $132[$133] = st["dataset"][$133];
                  }
                  ;
                }
                ;
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $141.dataset = function() {
                var $138 = {};
                for (var $139 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $139)) {
                    $138[$139] = st["dataset"][$139];
                  }
                  ;
                }
                ;
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 108, column 16 - line 149, column 29): " + [v.constructor.name]);
    };
  };
