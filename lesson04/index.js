      ...
      return function (dataset) {
          var nextDataset = function (c) {
              ...
              return {
                  ...
                  dx: (function () {
                      var $27 = Data_Ord.between(Data_Ord.ordNumber)(0.0 + ballRadius)(c.width - ballRadius)(dataset.x + dataset.dx);
                      if ($27) {
                          return dataset.dx;
                      };
                      return -dataset.dx;
                  ...
                  dy: (function () {
                      var $28 = Data_Ord.between(Data_Ord.ordNumber)(0.0 + ballRadius)(c.height - ballRadius)(dataset.y + dataset.dy);
                      if ($28) {
                          return dataset.dy;
                      };
                      return -dataset.dy;
      ...
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(initialize))(function (init) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(init))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                              return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                  var $70 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create);
                                  return function ($71) {
                                      return $70(Web_UIEvent_KeyboardEvent.fromEvent($71));
                                  };
                              })());
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                                  return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                      var $72 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create);
                                      return function ($73) {
                                          return $72(Web_UIEvent_KeyboardEvent.fromEvent($73));
                                      };
                                  })());
                              }))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bindFlipped(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe)(timer(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Tick.value)))(function () {
          ...
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (v1.maybeCanvas instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1.maybeCanvas instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(draw(v1.maybeCanvas.value0)(v1.dataset)))(function (newDataset) {
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $47.dataset = (function () {
                              var $44 = {};
                              for (var $45 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $45)) {
                                      $44[$45] = st["dataset"][$45];
                                  };
                              };
                              $44.rightPressed = true;
                              return $44;
                          })();
                          return $47;
                      });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Left" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowLeft") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $53.dataset = (function () {
                              var $50 = {};
                              for (var $51 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $51)) {
                                      $50[$51] = st["dataset"][$51];
                                  };
                              };
                              $50.leftPressed = true;
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $60.dataset = (function () {
                              var $57 = {};
                              for (var $58 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $58)) {
                                      $57[$58] = st["dataset"][$58];
                                  };
                              };
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Left" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowLeft") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $66.dataset = (function () {
                              var $63 = {};
                              for (var $64 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $64)) {
                                      $63[$64] = st["dataset"][$64];
                                  };
                              };
