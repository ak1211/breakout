...
(function($PS) {
  ...
  exports["btnOutlineInfo"] = btnOutlineInfo;
  ...
  exports["modalDialogCentered"] = modalDialogCentered;
...
(function($PS) {
  "use strict";
  $PS["Breakout"] = $PS["Breakout"] || {};
  var exports = $PS["Breakout"];
  var $foreign = $PS["Breakout"];
  ...
  var OnGame = (function () {
      ...
      OnGame.value = new OnGame();
      return OnGame;
  })();
  var RespawnGame = (function () {
      function RespawnGame() {

      };
      RespawnGame.value = new RespawnGame();
      return RespawnGame;
  })();
  ...
  var HandleAnimationFrame = (function () {
      ...
      HandleAnimationFrame.value = new HandleAnimationFrame();
  ...
  var HandleKeyUp = (function () {
      function HandleKeyUp(value0) {
          this.value0 = value0;
      };
      HandleKeyUp.create = function (value0) {
          return new HandleKeyUp(value0);
      };
      return HandleKeyUp;
  })();
  var HandleDialogCloseButton = (function () {
      function HandleDialogCloseButton(value0) {
          this.value0 = value0;
      };
      HandleDialogCloseButton.create = function (value0) {
          return new HandleDialogCloseButton(value0);
      };
      return HandleDialogCloseButton;
  })();
  var toStringScore = function (v) {
      return Data_Int.toStringAs(Data_Int.decimal)(v);
  };
  var toStringLives = function (v) {
      return Data_Int.toStringAs(Data_Int.decimal)(v);
  };
  var showScore = Data_Show.showInt;
  var showModalDialog = Effect_Uncurried.runEffectFn1($foreign.showModalDialogImpl);
  var showLives = Data_Show.showInt;
  var showBricksIndex = Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
  ...
  var paddleWidth = 75.0;
  var respawnDataset = function (canvas) {
      return function (ds) {
          return function __do() {
              var dim = Graphics_Canvas.getCanvasDimensions(canvas)();
              return {
                  x: dim.width / 2.0,
                  y: dim.height - 30.0,
                  dx: 2.0,
  ...
  var paddleHeight = 10.0;
  var ordBricksIndex = Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()({
      reflectSymbol: function () {
          return "row";
      }
  })(Data_Ord.ordInt))()({
  ...
  var modalDialog = function (input) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modal, Halogen_Themes_Bootstrap4.fade, Halogen_Themes_Bootstrap4.show ]), Halogen_HTML_Properties.id(input.modalId), Halogen_HTML_Properties.tabIndex(-1 | 0), Halogen_HTML_Properties.attr("role")("dialog"), Halogen_HTML_Properties.attr("data-backdrop")("static"), Halogen_HTML_Events.onKeyDown(function (v) {
          return new HandleDialogCloseButton(input);
      }) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modalDialog, Halogen_Themes_Bootstrap4.modalDialogCentered ]), Halogen_HTML_Properties.attr("role")("document") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalContent) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalHeader) ])([ Halogen_HTML_Elements.h5([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalTitle) ])([ Halogen_HTML_Core.text(input.title) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.close), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Properties.attr("data-dismiss")("modal"), Halogen_HTML_Properties.attr("area-label")("Close"), Halogen_HTML_Events.onClick(function (v) {
          return new HandleDialogCloseButton(input);
      }) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("area-hidden")("true") ])([ Halogen_HTML_Core.text("\xd7") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalBody) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(input.message) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalFooter) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnPrimary ]), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Properties.attr("data-dismiss")("modal"), Halogen_HTML_Events.onClick(function (v) {
          return new HandleDialogCloseButton(input);
      }) ])([ Halogen_HTML_Core.text("Close") ]) ]) ]) ]) ]);
  };
  var htmlElementById = function (elementId) {
      return function __do() {
          var document = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)();
          var nonElementParentNode = Web_HTML_HTMLDocument.toNonElementParentNode(document);
          var element = Web_DOM_NonElementParentNode.getElementById(elementId)(nonElementParentNode)();
          return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLElement.fromElement)(element);
      };
  };
  var hideModalDialog = Effect_Uncurried.runEffectFn1($foreign.hideModalDialogImpl);
  var genericBrickStatus = {
      to: function (x) {
          ...
          throw new Error("Failed pattern match at Breakout (line 70, column 1 - line 70, column 60): " + [ x.constructor.name ]);
      },
      from: function (x) {
  ...
  var showBrickStatus = {
      show: Data_Show_Generic.genericShow(genericBrickStatus)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
          reflectSymbol: function () {
              return "InActive";
          }
  ...
  var showBrick = Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
      reflectSymbol: function () {
          return "status";
      }
  })(Data_Show.showRecordFieldsCons({
  ...
  })(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showNumber))(showBrickStatus));
  var gameOverDialog = {
  ...
  var initialState = function (v) {
      return {
          maybeCanvas: Data_Maybe.Nothing.value,
          maybeEmitAnimationFrame: Data_Maybe.Nothing.value,
          dataset: {
              x: 0.0,
              y: 0.0,
              dx: 0.0,
              ...
              mouseMoved: false,
              mousePointClientX: 0,
              bricks: Data_Map_Internal.empty,
              score: firstScore,
              lives: firstLives
          }
      };
  ...
  var emitRequestAnimationFrame = function (val) {
      return Halogen_Subscription.makeEmitter(function (emitter) {
          return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(function __do() {
              ...
              var loop = function __do() {
                  emitter(val)();
                  var animationId = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.requestAnimationFrame(loop))(Web_HTML.window)();
                  return Effect_Ref.write(new Data_Maybe.Just(animationId))(ref)();
              };
              loop();
              return Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(ref))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(function (animationId) {
                  return Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.cancelAnimationFrame(animationId));
              }));
          });
      });
  };
  var consumeLives = function (v) {
      if (1 < v) {
          return Data_Maybe.Just.create(v - 1 | 0);
      };
      return Data_Maybe.Nothing.value;
  };
  var canvasId = "myCanvas";
  var render = function (state) {
      var headingOne = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.cardHeader, Halogen_Themes_Bootstrap4.p0 ]), Halogen_HTML_Properties.id("headingOne") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnOutlineInfo, Halogen_Themes_Bootstrap4.btnBlock ]), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Properties.attr("data-toggle")("collapse"), Halogen_HTML_Properties.attr("data-target")("#collapseOne"), Halogen_HTML_Properties.attr("area-controls")("collapseOne") ])([ Halogen_HTML_Core.text("\u3044\u307e\u306e\u72b6\u614b") ]) ]);
      var greeting = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.col) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.display4, Halogen_Themes_Bootstrap4.textCenter ]) ])([ Halogen_HTML_Core.text("BREAKOUT") ]), Halogen_HTML_Elements.hr([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.my4) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.lead) ])([ Halogen_HTML_Core.text("Use Arrow Keys or Mouse to play.") ]) ]);
      var collapseOne = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.collapse ]), Halogen_HTML_Properties.id("collapseOne"), Halogen_HTML_Properties.attr("area-labelledby")("headingOne"), Halogen_HTML_Properties.attr("data-parent")("#accordionExample"), Halogen_HTML_Properties.attr("area-expanded")("false") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.cardBody) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
          reflectSymbol: function () {
              return "bricks";
          }
      })(Data_Show.showRecordFieldsCons({
      ...
      })(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showNumber))(showScore))(Data_Show.showBoolean))(Data_Show.showNumber))(Data_Show.showInt))(Data_Show.showBoolean))(showLives))(Data_Show.showBoolean))(Data_Show.showNumber))(Data_Show.showNumber))(Data_Map_Internal.showMap(showBricksIndex)(showBrick))))(state.dataset)) ]) ]);
      var accordion = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col, Halogen_Themes_Bootstrap4.accordion ]), Halogen_HTML_Properties.id("accordionExample") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.card) ])([ headingOne, collapseOne ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.card) ])([  ]) ]);
      return Halogen_HTML_Elements.main([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.container) ])([ modalDialog(gameClearDialog), modalDialog(gameOverDialog), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ greeting ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ accordion ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.row, Halogen_Themes_Bootstrap4.justifyContentCenter ]) ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.m3, Halogen_Themes_Bootstrap4.border, Halogen_Themes_Bootstrap4.borderInfo ]), Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.background(CSS_Background["backgroundColor'"])(Color.rgb(238)(238)(238)))(function () {
          return CSS_Display.display(CSS_Display.block);
      })), Halogen_HTML_Properties.id(canvasId), Halogen_HTML_Properties.width(480), Halogen_HTML_Properties.height(320) ]) ]) ]);
  };
  var brickWidth = 75;
  var brickRowCount = 3;
  var brickPadding = 10;
  ...
  var collisionDetection = function (ball) {
      return function (bricks) {
          var inactivate = function (v) {
              return Data_Tuple.Tuple.create(v.value0)({
                  x: v.value1.x,
                  y: v.value1.y,
          ...
          var collidesBallAndBrick = function (v) {
              return function (v1) {
                  ...
                  if (v1.status instanceof Active) {
                      if (Data_Ord.between(Data_Ord.ordNumber)(v1.x)(v1.x + Data_Int.toNumber(brickWidth))(ball.x) && Data_Ord.between(Data_Ord.ordNumber)(v1.y)(v1.y + Data_Int.toNumber(brickHeight))(ball.y)) {
                          return true;
                      };
                      if (Data_Boolean.otherwise) {
                          return false;
                  ...
                  throw new Error("Failed pattern match at Breakout (line 651, column 42 - line 656, column 27): " + [ v1.status.constructor.name ]);
              };
          };
          return Data_Functor.map(Data_Maybe.functorMaybe)(inactivate)(Data_Array.head(Data_Map_Internal.toUnfoldableUnordered(Data_Unfoldable.unfoldableArray)(Data_Map_Internal.filterWithKey(ordBricksIndex)(collidesBallAndBrick)(bricks))));
      };
  };
  ...
  var coordinateBricks = function (bricks) {
      ...
      var coord = function (status) {
          return function (v) {
              return {
                  x: Data_Int.toNumber((v.column * (brickWidth + brickPadding | 0) | 0) + brickOffsetLeft | 0),
                  y: Data_Int.toNumber((v.row * (brickHeight + brickPadding | 0) | 0) + brickOffsetTop | 0),
                  status: status
              };
          };
      };
      return (function __do() {
          ...
          Control_Monad_ST_Internal["for"](0)(brickColumnCount)(function (c) {
              return Control_Monad_ST_Internal["for"](0)(brickRowCount)(function (r) {
                  var key = {
                      row: r,
                      column: c
                  };
                  var value = coord(Active.value)(key);
                  return Control_Monad_ST_Internal.modify(Data_Map_Internal.insertWith(ordBricksIndex)(modify)(key)(value))($$var);
              });
          })();
          return $$var.value;
      })();
  };
  var totalBricks = brickRowCount * brickColumnCount | 0;
      ...
      return function (c) {
          return function (canvasElementOffsetLeft) {
              var updateBricks = function (v1) {
                  return Data_Map_Internal.insert(ordBricksIndex)(v1.value0)(v1.value1)(v.bricks);
              };
              var nextPaddleX = (function () {
                  var relativeX = Data_Int.toNumber(v.mousePointClientX) - canvasElementOffsetLeft;
                  var cond = {
                      left: v.leftPressed,
                      right: v.rightPressed,
                      mouseMoved: v.mouseMoved
                  };
                  return Data_Ord.clamp(Data_Ord.ordNumber)(0.0)(c.width - paddleWidth)((function () {
                      if (!cond.left && cond.right) {
                          return v.paddleX + 7.0;
                      };
                      if (cond.left && !cond.right) {
                          return v.paddleX - 7.0;
                      };
                      if (cond.mouseMoved) {
                          return relativeX - paddleWidth / 2.0;
                      };
                      return v.paddleX;
                  })());
              })();
              ...
              var nextBricks = Data_Maybe.maybe(v.bricks)(updateBricks)(maybeCollisionedBrick);
              var hitRightWall = v.x + v.dx > c.width - ballRadius;
              var hitLeftWall = v.x + v.dx < ballRadius;
              var nextDx = (function () {
                  var $88 = hitLeftWall || hitRightWall;
                  if ($88) {
                      return -v.dx;
                  };
                  return v.dx;
              ...
              var hitPaddle = hitFloor && Data_Ord.between(Data_Ord.ordNumber)(v.paddleX)(v.paddleX + paddleWidth)(v.x + v.dx);
              var hitCeiling = v.y + v.dy < ballRadius;
              var hitBrick = Data_Maybe.isJust(maybeCollisionedBrick);
              var nextDy = (function () {
                  if (hitCeiling) {
                      return -v.dy;
                  };
                  ...
                  throw new Error("Failed pattern match at Breakout (line 623, column 12 - line 628, column 24): " + [ true ]);
              })();
              ...
              var nextGameSetAndNextLives = (function () {
                  ...
                  if (hitFloor && !hitPaddle) {
                      ...
                      throw new Error("Failed pattern match at Breakout (line 634, column 40 - line 636, column 71): " + [ v1.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return {
                  ...
                  throw new Error("Failed pattern match at Breakout (line 631, column 29 - line 637, column 71): " + [ true ]);
              })();
              return {
                  nextDataset: {
                      x: v.x + v.dx,
      ...
      return function (dataset) {
          var drawScore = function (v) {
              return function (score) {
                  return function __do() {
                      ...
                      Graphics_Canvas.setFont(ctx)("16px Arial")();
                      Graphics_Canvas.setFillStyle(ctx)("#0095DD")();
                      return Graphics_Canvas.fillText(ctx)("Score: " + toStringScore(score))(8.0)(20.0)();
                  };
              };
          };
          ...
          var drawLives = function (v) {
              return function (lives) {
                  return function __do() {
                      ...
                      Graphics_Canvas.setFont(ctx)("16px Arial")();
                      Graphics_Canvas.setFillStyle(ctx)("#0095DD")();
                      return Graphics_Canvas.fillText(ctx)("Lives: " + toStringLives(lives))(v.width - 65.0)(20.0)();
                  };
              };
          };
          var drawBricks = Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Map_Internal.foldableMap)(function (v) {
              if (Data_Eq.eq(eqBrickStatus)(v.status)(Active.value)) {
                  return function __do() {
                      var ctx = Graphics_Canvas.getContext2D(canvas)();
                      Graphics_Canvas.beginPath(ctx)();
                      Graphics_Canvas.rect(ctx)({
                          x: v.x,
                          y: v.y,
                          width: Data_Int.toNumber(brickWidth),
                          height: Data_Int.toNumber(brickHeight)
                      })();
                      Graphics_Canvas.setFillStyle(ctx)("#0095DD")();
                      Graphics_Canvas.fill(ctx)();
                      return Graphics_Canvas.closePath(ctx)();
          ...
          var canvasElementOffsetLeft = function (elemId) {
              return function __do() {
                  ...
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(0.0))(Web_HTML_HTMLElement.offsetLeft)(maybeCanvasElement)();
              };
          };
          return function __do() {
              var dim = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Graphics_Canvas.getCanvasDimensions(canvas))();
              var ctx = Graphics_Canvas.getContext2D(canvas)();
              ...
              var offsetLeft = canvasElementOffsetLeft(canvasId)();
              return nextDataset(dataset)(dim)(offsetLeft);
          };
      };
  };
  var handleAction = function (dictMonadAff) {
      var initialize = (function () {
          var st = initialState(Data_Unit.unit);
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  return {
                      maybeCanvas: new Data_Maybe.Just(v.value0),
                      dataset: {
                          bricks: bricks,
              ...
              throw new Error("Failed pattern match at Breakout (line 411, column 13 - line 421, column 22): " + [ v.constructor.name ]);
          };
      })();
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                      return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                          var $155 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create);
                          return function ($156) {
                              return $155(Web_UIEvent_KeyboardEvent.fromEvent($156));
                          };
                      })());
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                          return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                              var $157 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create);
                              return function ($158) {
                                  return $157(Web_UIEvent_KeyboardEvent.fromEvent($158));
                              };
                          })());
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (v1) {
                              return Halogen_Query_Event.eventListener(Web_UIEvent_MouseEvent_EventTypes.mousemove)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                  var $159 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleMouseMove.create);
                                  return function ($160) {
                                      return $159(Web_UIEvent_MouseEvent.fromEvent($160));
                                  };
                              })());
                          }))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(emitRequestAnimationFrame(HandleAnimationFrame.value)))(function (sid) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(initialize))(function (init) {
                                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                                          maybeEmitAnimationFrame: new Data_Maybe.Just(sid),
                                          dataset: init.dataset,
                                          maybeCanvas: init.maybeCanvas
                                      });
                                  });
                              });
                          });
          ...
          if (v instanceof Finalize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Data_Maybe.maybe(Data_Monoid.mempty(Halogen_Query_HalogenM.monoidHalogenM(Data_Monoid.monoidUnit)))(Halogen_Query_HalogenM.unsubscribe)(v1.maybeEmitAnimationFrame);
              });
          };
          if (v instanceof HandleAnimationFrame) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (v1.maybeCanvas instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(draw(v1.maybeCanvas.value0)(v1.dataset)))(function (ret) {
                          if (ret.gameset instanceof GameOver) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(showModalDialog(gameOverDialog.modalId));
                          };
                          if (ret.gameset instanceof GameClear) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(showModalDialog(gameClearDialog.modalId));
                          };
                          if (ret.gameset instanceof RespawnGame) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(respawnDataset(v1.maybeCanvas.value0)(ret.nextDataset)))(function (respawndData) {
                          ...
                          if (ret.gameset instanceof OnGame) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $117.dataset = ret.nextDataset;
                                  return $117;
                              });
                          };
                          throw new Error("Failed pattern match at Breakout (line 370, column 9 - line 376, column 70): " + [ ret.gameset.constructor.name ]);
                      });
                  };
          ...
          if (v instanceof HandleKeyDown) {
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $124.dataset = (function () {
                              var $121 = {};
                              for (var $122 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $122)) {
                                      $121[$122] = st["dataset"][$122];
                                  };
                              };
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Left" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowLeft") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $130 = {};
                          for (var $131 in st) {
                          ...
                          $130.dataset = (function () {
                              var $127 = {};
                              for (var $128 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $128)) {
                                      $127[$128] = st["dataset"][$128];
                                  };
                              };
                              $127.leftPressed = true;
                              return $127;
                          })();
                          return $130;
                      });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Right" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowRight") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $137.dataset = (function () {
                              var $134 = {};
                              for (var $135 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $135)) {
                                      $134[$135] = st["dataset"][$135];
                                  };
                              };
                              $134.rightPressed = false;
                              return $134;
                          })();
                          return $137;
                      });
              ...
              if (Web_UIEvent_KeyboardEvent.key(v.value0) === "Left" || Web_UIEvent_KeyboardEvent.key(v.value0) === "ArrowLeft") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $143.dataset = (function () {
                              var $140 = {};
                              for (var $141 in st.dataset) {
                                  if ({}.hasOwnProperty.call(st.dataset, $141)) {
                                      $140[$141] = st["dataset"][$141];
                                  };
                              };
                              $140.leftPressed = false;
                              return $140;
                          })();
                          return $143;
                      });
          ...
          if (v instanceof HandleMouseMove) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $150.dataset = (function () {
                      var $147 = {};
                      for (var $148 in st.dataset) {
                          if ({}.hasOwnProperty.call(st.dataset, $148)) {
                              $147[$148] = st["dataset"][$148];
                          };
                      };
                      $147.mouseMoved = true;
                      $147.mousePointClientX = Web_UIEvent_MouseEvent.clientX(v.value0);
                      return $147;
                  })();
                  return $150;
              });
          ...
          if (v instanceof HandleDialogCloseButton) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(hideModalDialog(v.value0.modalId)))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(initialize))(function (init) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(init);
                  });
              });
          };
          throw new Error("Failed pattern match at Breakout (line 337, column 16 - line 403, column 15): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Breakout.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();