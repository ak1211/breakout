...
(function($PS) {
      ...
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Graphics_Canvas.getCanvasElementById(canvasId)))(function (maybeCanvas) {
                  ...
                  throw new Error("Failed pattern match at Breakout (line 75, column 5 - line 81, column 18): " + [ maybeCanvas.constructor.name ]);
              });
          };
          ...
          throw new Error("Failed pattern match at Breakout (line 72, column 16 - line 87, column 73): " + [ v.constructor.name ]);
      };
  };
  var render = function (v) {
      ...
      })) ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id(canvasId), Halogen_HTML_Properties.width(480), Halogen_HTML_Properties.height(320) ]) ]);
  };
