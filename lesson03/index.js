(() => {
  ...
  var discard3 = /* @__PURE__ */ discard2(bindHalogenM);
  ...
  var discard4 = /* @__PURE__ */ discard2(bindStyleM);
  ...
  var nextDataset = function(v) {
    return function(v1) {
      return {
        ...
        y: v1.y + v1.dy,
        dx: function() {
          var $54 = between2(0 + v1.ballRadius)(v.width - v1.ballRadius)(v1.x + v1.dx);
          if ($54) {
            return v1.dx;
          }
          ;
        ...
        dy: function() {
          var $55 = between2(0 + v1.ballRadius)(v.height - v1.ballRadius)(v1.y + v1.dy);
          if ($55) {
            return v1.dy;
          }
          ;
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function(canvas2) {
      return function(dim) {
        return new Just({
          canvas: canvas2,
          dataset: {
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind12(liftEffect12(getCanvasElementById(canvasId)))(function(maybeCanvas) {
          if (maybeCanvas instanceof Nothing) {
            return put2(Nothing.value);
          }
          ;
          if (maybeCanvas instanceof Just) {
            return bind12(liftEffect12(getCanvasDimensions(maybeCanvas.value0)))(function(dim) {
              return discard3(put2(initialize(maybeCanvas.value0)(dim)))(function() {
                return bind12(bindFlipped4(subscribe2)(timer1(Tick.value)))(function() {
                  return pure5(unit);
                });
              });
            });
          ...
          ;
          throw new Error("Failed pattern match at Breakout (line 83, column 5 - line 89, column 18): " + [maybeCanvas.constructor.name]);
        });
      }
      ;
      if (v instanceof Tick) {
        return bind12(get2)(maybe(mempty2)(function(state3) {
          return bind12(liftEffect12(getCanvasDimensions(state3.canvas)))(function(dim) {
            return discard3(liftEffect12(draw(state3.canvas)(dim)(state3.dataset)))(function() {
              return put2(new Just(function() {
                var $66 = {};
                ...
                ;
                $66.dataset = nextDataset(dim)(state3.dataset);
                return $66;
              }()));
            });
          });
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 80, column 16 - line 95, column 73): " + [v.constructor.name]);
    };
  };
  var render2 = function(v) {
    return main([style2(discard4(margin(px(0))(px(0))(px(0))(px(0)))(function() {
      return padding(px(0))(px(0))(px(0))(px(0));
    }))])([canvas([style2(discard4(background2(rgb(238)(238)(238)))(function() {
      return discard4(display(block))(function() {
        return discard4(marginTop(px(0)))(function() {
          return discard4(marginRight(auto2))(function() {
            return discard4(marginBottom(px(0)))(function() {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element4) {
        return bind15(liftEffect7(map19(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
