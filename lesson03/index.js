  ...
  var nextDataset = function (v) {
      return function (v1) {
          return {
              ...
              y: v1.y + v1.dy,
              dx: (function () {
                  var $17 = Data_Ord.between(Data_Ord.ordNumber)(0.0 + v1.ballRadius)(v.width - v1.ballRadius)(v1.x + v1.dx);
                  if ($17) {
                      return v1.dx;
                  };
                  return -v1.dx;
              ...
              dy: (function () {
                  var $18 = Data_Ord.between(Data_Ord.ordNumber)(0.0 + v1.ballRadius)(v.height - v1.ballRadius)(v1.y + v1.dy);
                  if ($18) {
                      return v1.dy;
                  };
                  return -v1.dy;
  ...
  var handleAction = function (dictMonadAff) {
      ...
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Graphics_Canvas.getCanvasElementById(canvasId)))(function (maybeCanvas) {
                  if (maybeCanvas instanceof Data_Maybe.Nothing) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Maybe.Nothing.value);
                  };
                  if (maybeCanvas instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Graphics_Canvas.getCanvasDimensions(maybeCanvas.value0)))(function (dim) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(initialize(maybeCanvas.value0)(dim)))(function () {
          ...
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(Data_Maybe.maybe(Data_Monoid.mempty(Halogen_Query_HalogenM.monoidHalogenM(Data_Monoid.monoidUnit)))(function (state) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Graphics_Canvas.getCanvasDimensions(state.canvas)))(function (dim) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(draw(state.canvas)(dim)(state.dataset)))(function () {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new Data_Maybe.Just((function () {
                              var $29 = {};
                              for (var $30 in state) {
                              ...
                              $29.dataset = nextDataset(dim)(state.dataset);
                              return $29;
                          })()));
                      });
                  });
