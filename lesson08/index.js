(() => {
  ...
  var genericBrickStatus = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 68, column 1 - line 68, column 60): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  var nextDataset = function(v) {
    return function(c) {
      ...
      var nextDyAndGameset = function(collisioned) {
        ...
        ;
        throw new Error("Failed pattern match at Breakout (line 406, column 7 - line 412, column 57): " + [true]);
      };
      var nextDx = function() {
        var $196 = between2(ballRadius)(c.width - ballRadius)(v.x + v.dx);
        if ($196) {
          return v.dx;
        }
        ;
        ...
        return function(bricks) {
          ...
          var collisioned = function(v12) {
            return function(v2) {
              ...
              ;
              throw new Error("Failed pattern match at Breakout (line 429, column 35 - line 434, column 29): " + [v2.status.constructor.name]);
            };
          };
          return head(map14(inactivate)(toUnfoldableUnordered2(filterWithKey2(collisioned)(bricks))));
        };
      };
      var nextBricksAndCollisioned = function() {
        ...
        ;
        throw new Error("Failed pattern match at Breakout (line 380, column 30 - line 388, column 8): " + [v12.constructor.name]);
      }();
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function __do2() {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 229, column 11 - line 247, column 16): " + [v.constructor.name]);
    };
    return function(v) {
        ...
        return bind22(liftEffect22(bindFlipped4(document2)(windowImpl)))(function(document3) {
          return discard5(subscribe$prime(function(v1) {
            return eventListener2(keydown)(toEventTarget(document3))(function() {
              var $267 = map15(HandleKeyDown.create);
              return function($268) {
                return $267(fromEvent($268));
              };
            }());
          }))(function() {
            return discard5(subscribe$prime(function(v1) {
              return eventListener2(keyup)(toEventTarget(document3))(function() {
                var $269 = map15(HandleKeyUp.create);
                return function($270) {
                  return $269(fromEvent($270));
                };
              }());
            }))(function() {
              return bind22(bindFlipped1(subscribe2)(timer1(Tick.value)))(function(sid) {
      ...
      if (v instanceof Tick) {
        return bind22(get2)(function(v1) {
          ...
          if ($232.a instanceof Just && $232.b instanceof Just) {
            return bind22(liftEffect22(draw($232.a.value0)(v1.dataset)))(function(ret) {
              if (ret.gameset instanceof GameOver) {
                return discard5(liftEffect22(bindFlipped4(alert("GAME OVER"))(windowImpl)))(function() {
                  return discard5(unsubscribe2($232.b.value0))(function() {
              ...
              if (ret.gameset instanceof OnGame) {
                return modify_3(function(st) {
                  ...
                  ;
                  $234.dataset = ret.nextDataset;
                  return $234;
                });
              }
              ;
              throw new Error("Failed pattern match at Breakout (line 198, column 9 - line 207, column 70): " + [ret.gameset.constructor.name]);
            });
          }
          ;
          return pure1(unit);
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $244.dataset = function() {
                var $241 = {};
                for (var $242 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $242)) {
                    $241[$242] = st["dataset"][$242];
                  }
                  ;
                }
                ;
                $241.rightPressed = true;
                return $241;
              }();
              return $244;
            });
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $257.dataset = function() {
                var $254 = {};
                for (var $255 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $255)) {
                    $254[$255] = st["dataset"][$255];
                  }
                  ;
                }
                ;
                $254.rightPressed = false;
                return $254;
              }();
              return $257;
            });
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 174, column 16 - line 224, column 29): " + [v.constructor.name]);
    };
  };
