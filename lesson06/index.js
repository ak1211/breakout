(() => {
  ...
  var functorWriterT = function(dictFunctor) {
    ...
    return {
      map: function(f) {
        return mapWriterT(map21(function(v) {
  ...
  var showBrick = /* @__PURE__ */ showRecord2(showRecordFieldsCons2);
  ...
  var nextDataset = function(dataset) {
    return function(c) {
      ...
      var v = function() {
        ...
        ;
        throw new Error("Failed pattern match at Breakout (line 318, column 9 - line 323, column 59): " + [true]);
      }();
      return {
        nextDataset: {
          ...
          dx: function() {
            var $154 = between2(ballRadius)(c.width - ballRadius)(dataset.x + dataset.dx);
            if ($154) {
              return dataset.dx;
            }
            ;
        ...
        return function __do2() {
          ...
          forST(0)(brickColumnCount)(function(c) {
            return forST(0)(brickRowCount)(function(r) {
              ...
              var value14 = coord(key5);
              return modify2(insert4(key5)(value14))($$var2);
            });
          })();
          return $$var2.value;
        }();
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function __do2() {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 200, column 11 - line 217, column 16): " + [v.constructor.name]);
    };
    return function(v) {
        ...
        return bind22(liftEffect22(bindFlipped4(document2)(windowImpl)))(function(document3) {
          return discard5(subscribe$prime(function(v1) {
            return eventListener2(keydown)(toEventTarget(document3))(function() {
              var $206 = map11(HandleKeyDown.create);
              return function($207) {
                return $206(fromEvent($207));
              };
            }());
          }))(function() {
            return discard5(subscribe$prime(function(v1) {
              return eventListener2(keyup)(toEventTarget(document3))(function() {
                var $208 = map11(HandleKeyUp.create);
                return function($209) {
                  return $208(fromEvent($209));
                };
              }());
            }))(function() {
      ...
      if (v instanceof Tick) {
        return bind22(get2)(function(v1) {
          ...
          if ($171.a instanceof Just && $171.b instanceof Just) {
            return bind22(liftEffect22(draw($171.a.value0)(v1.dataset)))(function(ret) {
              if (ret.gameover) {
                return discard5(liftEffect22(bindFlipped4(alert("GAME OVER"))(windowImpl)))(function() {
                  return discard5(liftEffect22(bindFlipped4(reload)(bindFlipped4(location)(windowImpl))))(function() {
                    return unsubscribe2($171.b.value0);
                  });
                });
              }
              ;
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $183.dataset = function() {
                var $180 = {};
                for (var $181 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $181)) {
                    $180[$181] = st["dataset"][$181];
                  }
                  ;
                }
                ;
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $189.dataset = function() {
                var $186 = {};
                for (var $187 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $187)) {
                    $186[$187] = st["dataset"][$187];
                  }
                  ;
                }
                ;
                $186.leftPressed = true;
                return $186;
              }();
              return $189;
            });
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $196.dataset = function() {
                var $193 = {};
                for (var $194 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $194)) {
                    $193[$194] = st["dataset"][$194];
                  }
                  ;
                }
                ;
                $193.rightPressed = false;
                return $193;
              }();
              return $196;
            });
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard5(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $202.dataset = function() {
                var $199 = {};
                for (var $200 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $200)) {
                    $199[$200] = st["dataset"][$200];
                  }
                  ;
                }
                ;
                $199.leftPressed = false;
                return $199;
              }();
              return $202;
            });
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 149, column 16 - line 195, column 29): " + [v.constructor.name]);
    };
  };
  ...
  var selectElement = function(query2) {
    return bind5(liftEffect4(bindFlipped5(composeKleisliFlipped2(function() {
      ...
      return pure5(bindFlipped12(fromElement)(mel));
    });
  };
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element4) {
        return bind14(liftEffect7(map20(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
