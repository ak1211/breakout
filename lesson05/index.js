(() => {
  ...
  })(showNumber))(showNumber))(showBoolean))(showNumber))(showBoolean))(showNumber))(showNumber)));
  ...
  var timer = function(dictMonadAff) {
    ...
    return function(val) {
      return bind22(liftEffect22(create))(function(v) {
        return bind22(liftAff2(forkAff(forever2(discard1(delay(10))(function() {
    ...
    return function(dataset) {
      var nextDataset = function(c) {
        ...
        var v = function() {
          ...
          ;
          throw new Error("Failed pattern match at Breakout (line 243, column 11 - line 248, column 61): " + [true]);
        }();
        return {
          nextDataset: {
            ...
            dx: function() {
              var $109 = between2(ballRadius)(c.width - ballRadius)(dataset.x + dataset.dx);
              if ($109) {
                return dataset.dx;
              }
              ;
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var initialize = function __do2() {
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 163, column 11 - line 179, column 16): " + [v.constructor.name]);
    };
    return function(v) {
      if (v instanceof Initialize2) {
        return bind12(liftEffect22(bindFlipped4(document2)(windowImpl)))(function(document3) {
          return discard4(subscribe$prime(function(v1) {
            return eventListener2(keydown)(toEventTarget(document3))(function() {
              var $157 = map11(HandleKeyDown.create);
              return function($158) {
                return $157(fromEvent($158));
              };
            }());
          }))(function() {
            return discard4(subscribe$prime(function(v1) {
              return eventListener2(keyup)(toEventTarget(document3))(function() {
                var $159 = map11(HandleKeyUp.create);
                return function($160) {
                  return $159(fromEvent($160));
                };
              }());
            }))(function() {
              return bind12(bindFlipped1(subscribe2)(timer1(Tick.value)))(function(sid) {
                return bind12(liftEffect22(initialize))(function(init3) {
                  return put2({
      ...
      if (v instanceof Tick) {
        return bind12(get2)(function(v1) {
          var $122 = {
            a: v1.maybeCanvas,
            b: v1.maybeTimer
          };
          if ($122.a instanceof Just && $122.b instanceof Just) {
            return bind12(liftEffect22(draw($122.a.value0)(v1.dataset)))(function(ret) {
              if (ret.gameover) {
                return discard4(liftEffect22(bindFlipped4(alert("GAME OVER"))(windowImpl)))(function() {
                  return discard4(liftEffect22(bindFlipped4(reload)(bindFlipped4(location)(windowImpl))))(function() {
                    return unsubscribe2($122.b.value0);
                  });
                });
              }
              ;
      ...
      if (v instanceof HandleKeyDown) {
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              var $134 = {};
              for (var $135 in st) {
              ...
              ;
              $134.dataset = function() {
                var $131 = {};
                for (var $132 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $132)) {
                    $131[$132] = st["dataset"][$132];
                  }
                  ;
                }
                ;
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $140.dataset = function() {
                var $137 = {};
                for (var $138 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $138)) {
                    $137[$138] = st["dataset"][$138];
                  }
                  ;
                }
                ;
                $137.leftPressed = true;
                return $137;
              }();
              return $140;
            });
        ...
        if (key4(v.value0) === "Right" || key4(v.value0) === "ArrowRight") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $147.dataset = function() {
                var $144 = {};
                for (var $145 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $145)) {
                    $144[$145] = st["dataset"][$145];
                  }
                  ;
                }
                ;
                $144.rightPressed = false;
                return $144;
              }();
              return $147;
            });
        ...
        if (key4(v.value0) === "Left" || key4(v.value0) === "ArrowLeft") {
          return discard4(liftEffect22(preventDefault(toEvent(v.value0))))(function() {
            return modify_3(function(st) {
              ...
              ;
              $153.dataset = function() {
                var $150 = {};
                for (var $151 in st.dataset) {
                  if ({}.hasOwnProperty.call(st.dataset, $151)) {
                    $150[$151] = st["dataset"][$151];
                  }
                  ;
                }
                ;
                $150.leftPressed = false;
                return $150;
              }();
              return $153;
            });
      ...
      ;
      throw new Error("Failed pattern match at Breakout (line 112, column 16 - line 158, column 29): " + [v.constructor.name]);
    };
  };
        ...
        var go2 = function(ref2) {
          return function(v1) {
            ...
            if (v1 instanceof Subscribe) {
              return bind13(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind13(liftEffect5(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind13(liftEffect5(read(ref2)))(function(v2) {
                    return discard12(liftEffect5(modify_(map22(insert4(sid)(finalize)))(v2.subscriptions)))(function() {
            ...
            if (v1 instanceof Raise) {
              return bind13(liftEffect5(read(ref2)))(function(v2) {
                return bind13(liftEffect5(read(v2.handlerRef)))(function(handler2) {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element4) {
        return bind15(liftEffect7(map20(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
